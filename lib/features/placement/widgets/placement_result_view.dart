                      ...
                      PlacementReveal(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border(
                              top: BorderSide(color: _placementLine),
                            ),
                          ),
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final ringSize = (constraints.maxWidth * 0.36).clamp(112.0, 138.0);
  ...
  Widget build(BuildContext context) {
    return TweenAnimationBuilder<double>(
      ...
      builder: (context, value, _) {
        final indicatorSize = size - 6;
        final strokeWidth = (size * 0.082).clamp(11.0, 14.0);
        return SizedBox(
          width: size,
          height: size,
          child: Stack(
    ...
    return PlacementSurface(
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final tileHeight = columns == 3
              ? 116.0
              : (tileWidth * 0.68).clamp(112.0, 132.0);
