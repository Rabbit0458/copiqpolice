      ...
      body: Stack(
        children: [
          GestureDetector(
            ...
            // Les shells réservent déjà la barre via Scaffold ou SafeArea.
            // Respecter les insets restants sans soustraire une seconde barre.
            child: SafeArea(
              child: LayoutBuilder(
                    ...
                    children: [
                      ...
                      ConstrainedBox(
                        constraints: BoxConstraints(
                          minHeight: compact ? 0 : headerHeight,
                        ),
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          ...
                          children: [
                            ...
                            ValueListenableBuilder<Entitlement>(
                              valueListenable:
                                  EntitlementService.instance.state,
