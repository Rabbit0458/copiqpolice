      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/memento_circulation/controle_routier/bsr_page.dart",
            "f00001",
            'Retour',
          ),
        ),
        ...
        children: [
          ...
          _ConditionCard(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/memento_circulation/controle_routier/bsr_page.dart",
              "f00010",
              "II — Conditions d’obligation (qui est concerné ?)",
            ),
            cardColor: cardRules,
            accent: accentGreen,
            titleColor: textMain,
          ...
          _ConditionCard(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/memento_circulation/controle_routier/bsr_page.dart",
              "f00019",
              "III — Catégorie AM (depuis 19/01/2013)",
            ),
          ...
          _ConditionCard(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/memento_circulation/controle_routier/bsr_page.dart",
              "f00029",
              "IV — Particularité juridique du B.S.R.",
            ),
            cardColor: cardRules,
            accent: accentGreen,
            titleColor: textMain,
            ...
            children: [
              ...
              _BulletPoint(
                text: ScolariteText.value(
                  "lib/content/gpx_scolarite/memento_circulation/controle_routier/bsr_page.dart",
                  "f00039",
                  "Cyclomoteur : NATINF 11384 (mineur de moins de 14 ans).",
                ),
              ),
              _BulletPoint(
                text: ScolariteText.value(
              ...
              _SubTitle(
                ScolariteText.value(
                  "lib/content/gpx_scolarite/memento_circulation/controle_routier/bsr_page.dart",
                  "f00041",
                  "B) Défaut de B.S.R. / titre équivalent",
                ),
              ),
              _Paragraph.rich([
                TextSpan(
              ...
              _SubTitle(
                ScolariteText.value(
                  "lib/content/gpx_scolarite/memento_circulation/controle_routier/bsr_page.dart",
                  "f00052",
                  "C) Non-justification dans les 5 jours",
                ),
              ),
              _Paragraph.rich([
                TextSpan(
