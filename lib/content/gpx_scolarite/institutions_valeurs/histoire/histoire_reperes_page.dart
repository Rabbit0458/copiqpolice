...
class HistoireReperesPage extends StatelessWidget {
  const HistoireReperesPage({super.key});

  static const String routeName = '/gpx/institution/histoire/reperes';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/institutions_valeurs/histoire/histoire_reperes_page.dart",
            "f00001",
            'Retour',
          ),
        ),
