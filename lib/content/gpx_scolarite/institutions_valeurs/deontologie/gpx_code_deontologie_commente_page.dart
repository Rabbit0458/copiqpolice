...
class CodeDeontologieCodeCommentePage extends StatelessWidget {
  const CodeDeontologieCodeCommentePage({super.key});

  static const String routeName = '/gpx/institution/deontologie/code_commente';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/institutions_valeurs/deontologie/gpx_code_deontologie_commente_page.dart",
            "f00001",
            'Retour',
          ),
        ),
