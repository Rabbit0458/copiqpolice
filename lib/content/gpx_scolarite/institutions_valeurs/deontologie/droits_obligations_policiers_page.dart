...
class DroitsObligationsPoliciersPage extends StatelessWidget {
  const DroitsObligationsPoliciersPage({super.key});

  static const String routeName =
      '/gpx/institution/deontologie/droits_obligations';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/institutions_valeurs/deontologie/droits_obligations_policiers_page.dart",
            "f00001",
            'Retour',
          ),
        ),
