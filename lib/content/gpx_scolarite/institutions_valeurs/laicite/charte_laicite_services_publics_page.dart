...
class CharteLaiciteServicesPublicsPage extends StatelessWidget {
  const CharteLaiciteServicesPublicsPage({super.key});

  static const String routeName = '/gpx/institution/laicite/charte';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/institutions_valeurs/laicite/charte_laicite_services_publics_page.dart",
            "f00001",
            'Retour',
          ),
        ),
