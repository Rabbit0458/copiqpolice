...
class SuitePrelevementSanguinPage extends StatelessWidget {
  const SuitePrelevementSanguinPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    // Palette (dans l’esprit de ton template)
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/pv_apj20/circulation_routiere/stupefiants/suite_prelevement_sanguin_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
              ...
              _Paragraph.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/pv_apj20/circulation_routiere/stupefiants/suite_prelevement_sanguin_page.dart",
                    "f00005",
                    "Le prélèvement sanguin intervient après un prélèvement salivaire lorsque le conducteur se réserve le droit de demander un examen technique / une expertise, ou la recherche de l’usage de médicaments psychoactifs, conformément aux ",
                  ),
                ),
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/pv_apj20/circulation_routiere/stupefiants/suite_prelevement_sanguin_page.dart",
                    "f00006",
                    "articles L.235-2 et suivants, R.235-6 et R.235-11 du Code de la route",
                  ),
          ...
          _ConditionCard(
            ...
            children: const [
              ZoomableAssetImage(
                assetPath: 'assets/images/suite_prelevement_sanguin.png',
                heroTag: 'suite_prelevement_sanguin',
              ),
            ],
          ),
        ],
