        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _Paragraph.rich([
                TextSpan(text: "Le suspect libre est une personne ("),
                TextSpan(
                  text: "art. 61-1 C.P.P.",
                  style: TextStyle(
                    color: _lawRed,
              ...
              SizedBox(height: 12),
              _SubTitle("À distinguer : le témoin"),
              _Paragraph.rich([
                TextSpan(
                  text:
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle("1) Absence de contrainte"),
              _Paragraph.rich([
                TextSpan(text: "Principe : pas de contrainte ("),
                TextSpan(
              ...
              SizedBox(height: 10),
              _SubTitle("Indicateurs typiques de contrainte"),
              _BulletPoint(
                text:
                    "Personne contrainte à monter dans le véhicule de police.",
              ),
              _BulletPoint(text: "Personne menottée durant le trajet."),
              SizedBox(height: 10),
              _NotaBox(
                bodySpans: [
                  TextSpan(
              ...
              SizedBox(height: 12),
              _SubTitle("Conséquences si contrainte"),
              _BulletPoint(
                text:
              ...
              SizedBox(height: 10),
              _SubTitle("• Dépistage alcool/stupéfiants positif"),
              _Paragraph.rich([
                TextSpan(
                  text:
              ...
              _Paragraph.rich([
                ...
                TextSpan(text: "), conformément à l’"),
                TextSpan(
              ...
              _SubTitle("3) Cadres d’enquête"),
              _BulletPoint(text: "Enquête de flagrance."),
              _BulletPoint(text: "Enquête préliminaire."),
              _BulletPoint(text: "Commission rogatoire (exécution)."),
            ],
          ),
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle("A) Convocation du mis en cause"),
              _Paragraph(
              ...
              _SubTitle("B) Notification des droits"),
              _Paragraph.rich([
                TextSpan(
                  text:
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle("A) Droits à notifier avant toute audition"),
              _Paragraph.rich([
              ...
              _BulletPoint(text: "Droit à un interprète, si nécessaire."),
              _BulletPoint(
                text:
                    "Droit de faire des déclarations, répondre aux questions ou se taire.",
              ),
              SizedBox(height: 12),
              _SubTitle("Assistance d’un avocat (conditions)"),
              _Paragraph(
              ...
              SizedBox(height: 12),
              _SubTitle("Accès à certaines pièces"),
              _Paragraph(
              ...
              SizedBox(height: 12),
              _SubTitle("Conseils juridiques (accès au droit)"),
              _Paragraph(
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle("1) Avis aux représentants légaux"),
              _Paragraph.rich([
              ...
              SizedBox(height: 12),
              _SubTitle("2) Assistance d’un avocat"),
              _Paragraph.rich([
                TextSpan(text: "Référence : "),
                TextSpan(
                ...
                TextSpan(text: " : le mineur est assisté d’un avocat."),
              ]),
              SizedBox(height: 8),
              _Paragraph(
              ...
              SizedBox(height: 12),
              _SubTitle("3) Droit à l’information"),
              _Paragraph.rich([
                TextSpan(text: "Référence : "),
                TextSpan(
              ...
              SizedBox(height: 12),
              _SubTitle("4) Droit à l’accompagnement"),
              _Paragraph.rich([
                TextSpan(text: "Référence : "),
                TextSpan(
