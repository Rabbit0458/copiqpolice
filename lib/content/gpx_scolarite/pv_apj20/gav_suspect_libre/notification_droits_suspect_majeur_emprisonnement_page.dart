...
class NotificationDroitsSuspectMajeurEmprisonnementPage
  ...
  const NotificationDroitsSuspectMajeurEmprisonnementPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final Color cardMode = isDark
        ? const Color(0xFF2A1F2D)
        : const Color(0xFFFFF1F8);
    final Color cardDroits = isDark
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              ZoomableAssetImage(
                assetPath:
                    'assets/images/notifications_droits_suspect_majeur_recto.png',
              ),
              SizedBox(height: 12),
              ZoomableAssetImage(
                assetPath:
                    'assets/images/notifications_droits_suspect_majeur_verso.png',
              ),
            ],
          ),
        ],
