        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              SizedBox(height: 12),
              _SubTitle("A) Information sur la mesure"),
              _Paragraph.rich([
                TextSpan(text: "Au titre de l’"),
                TextSpan(
                  text: "article 63-1 C.P.P.",
                  style: TextStyle(
                    color: _lawRed,
                ...
                TextSpan(text: ", la personne est informée :"),
              ]),
              SizedBox(height: 8),
              _BulletPoint(
                text:
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _SubTitle("1) Droit de faire prévenir"),
              _Paragraph.rich([
                TextSpan(
              ...
              _BulletPoint(text: "Son employeur."),
              _BulletPoint(
                text:
              ...
              _SubTitle("2) Droit de communiquer"),
              _Paragraph.rich([
                TextSpan(
              ...
              _SubTitle("3) Droit à un examen médical"),
              _Paragraph.rich([
                TextSpan(
              ...
              SizedBox(height: 8),
              _BulletPoint(text: "Demandé par la personne gardée à vue."),
              _BulletPoint(
              ...
              _SubTitle("4) Droit à l’assistance d’un avocat"),
              _Paragraph.rich([
                TextSpan(
              ...
              SizedBox(height: 10),
              _SubTitle("Contenu du droit"),
              _BulletPoint(text: "Entretien confidentiel de 30 minutes."),
              _BulletPoint(
                text:
                    "Consultation de certains PV (notification GAV/droits, certificat médical, PV d’audition/confrontation).",
              ),
              _BulletPoint(text: "Aucune copie des documents consultés."),
              _BulletPoint(
                text:
              ...
              _SubTitle("6) Droit de consulter certaines pièces"),
              _Paragraph.rich([
                TextSpan(
                  text: "Article 63-4-1 C.P.P.",
                  style: TextStyle(
              ...
              _BulletPoint(text: "Certificat médical."),
              _BulletPoint(
              ...
              _SubTitle("7) Droit de présenter des observations"),
              _Paragraph(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              SizedBox(height: 12),
              _SubTitle("Garanties supplémentaires"),
