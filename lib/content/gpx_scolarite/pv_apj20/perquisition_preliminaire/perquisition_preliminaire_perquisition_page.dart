...
class PerquisitionPreliminairePerquisitionPage extends StatelessWidget {
  ...
  static const String routeName =
      '/gpx/pv_apj20/perquisition_preliminaire/perquisition';
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              const _SubTitle("8) Présence de l’occupant"),
              const _Paragraph(
              ...
              const _SubTitle("9) Perquisition (description du local)"),
              const _BulletPoint(
                text:
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              SizedBox(height: 12),
              ZoomableAssetImage(
                assetPath: 'assets/images/perquisition_preliminaire_recto.png',
                heroTag: 'perquisition_preliminaire_recto',
              ),
              SizedBox(height: 12),
              ZoomableAssetImage(
                assetPath: 'assets/images/perquisition_preliminaire_verso.png',
                heroTag: 'perquisition_preliminaire_verso',
              ),
            ],
          ),
        ],
