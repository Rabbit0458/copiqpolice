...
class QuizVoisinesDuVolGPX extends StatefulWidget {
  ...
  @override
  State<QuizVoisinesDuVolGPX> createState() => _QuizVoisinesDuVolGPXState();
}

class _QuizVoisinesDuVolGPXState extends State<QuizVoisinesDuVolGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_voisines_du_vol';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_voisines_du_vol',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_voisines_du_vol',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Distingue le vol des infractions voisines : extorsion, chantage, abus de confiance, escroquerie, recel et leurs spécificités.',
