...
// PAGE
// ============================================================================
class QuizAtteintePersonnaliteGPX extends StatefulWidget {
  ...
  const QuizAtteintePersonnaliteGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteintePersonnaliteGPX> createState() => _QuizAtteintePersonnaliteGPXState();
}

class _QuizAtteintePersonnaliteGPXState extends State<QuizAtteintePersonnaliteGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_atteinte_personnalite';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_atteinte_personnalite',
