...
// PAGE
// ============================================================================
class QuizMisePerilMineurGPX extends StatefulWidget {
  ...
  @override
  State<QuizMisePerilMineurGPX> createState() => _QuizMisePerilMineurGPXState();
}

class _QuizMisePerilMineurGPXState extends State<QuizMisePerilMineurGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_mise_peril_mineurs';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_mise_peril_mineurs',
