...
// PAGE
// ============================================================================
class QuizProbiteGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName = '/gpx/nation/quiz/probite';
  final String uid;
  final String email;

  const QuizProbiteGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizProbiteGPX> createState() => _QuizProbiteGPXState();
}

class _QuizProbiteGPXState extends State<QuizProbiteGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_probite';
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Probité',
                                description:
                                    'Étudie les infractions contre la probité : corruption active et passive, trafic d’influence, favoritisme, éléments constitutifs et sanctions.',
