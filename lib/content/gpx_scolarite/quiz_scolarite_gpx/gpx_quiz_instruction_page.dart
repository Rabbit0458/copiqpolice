...
// PAGE
// ============================================================================
class QuizInstructionPageGPX extends StatefulWidget {
  ...
  @override
  State<QuizInstructionPageGPX> createState() => _QuizInstructionPageGPXState();
}

class _QuizInstructionPageGPXState extends State<QuizInstructionPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_instruction';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_instruction_page',
