...
class QuizDroitPenalePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizDroitPenalePageGPX> createState() => _QuizDroitPenalePageGPXState();
}

class _QuizDroitPenalePageGPXState extends State<QuizDroitPenalePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_droit_penale';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_droit_penale',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Droit pénal',
                                description:
                                    'Approfondis les fondements du droit pénal : principes généraux, éléments constitutifs des infractions, classification et application de la loi pénale.',
