...
// PAGE
// ============================================================================
class QuizLibertesPubliquesIndividuellesPageGPX extends StatefulWidget {
  ...
  const QuizLibertesPubliquesIndividuellesPageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizLibertesPubliquesIndividuellesPageGPX> createState() =>
      _QuizLibertesPubliquesIndividuellesPageGPXState();
}

class _QuizLibertesPubliquesIndividuellesPageGPXState
    extends State<QuizLibertesPubliquesIndividuellesPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_libertes_publiques_individuelles';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_libertes_publiques_individuelles_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_libertes_publiques_individuelles_page',
