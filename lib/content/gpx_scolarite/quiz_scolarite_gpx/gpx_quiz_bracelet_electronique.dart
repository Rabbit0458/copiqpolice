...
// PAGE
// ============================================================================
class QuizBraceletElectroniquePageGPX extends StatefulWidget {
  ...
  const QuizBraceletElectroniquePageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizBraceletElectroniquePageGPX> createState() => _QuizBraceletElectroniquePageGPXState();
}

class _QuizBraceletElectroniquePageGPXState extends State<QuizBraceletElectroniquePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_bracelet_electronique';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_bracelet_electronique',
