...
// PAGE
// ============================================================================
class QuizStupefiantGPX extends StatefulWidget {
  ...
  const QuizStupefiantGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizStupefiantGPX> createState() => _QuizStupefiantGPXState();
}

class _QuizStupefiantGPXState extends State<QuizStupefiantGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_stupefiants';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_stupéfiants',
