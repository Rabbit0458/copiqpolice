...
// PAGE
// ============================================================================
class QuizMineursFamilleGPX extends StatefulWidget {
  ...
  const QuizMineursFamilleGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizMineursFamilleGPX> createState() => _QuizMineursFamilleGPXState();
}

class _QuizMineursFamilleGPXState extends State<QuizMineursFamilleGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_mineurs_famille';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_mineurs_famille',
