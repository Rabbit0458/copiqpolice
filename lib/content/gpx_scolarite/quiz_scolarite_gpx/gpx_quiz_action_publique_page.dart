...
class QuizActionPubliquePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizActionPubliquePageGPX> createState() =>
      _QuizActionPubliquePageGPXState();
}

class _QuizActionPubliquePageGPXState extends State<QuizActionPubliquePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_action_publique';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_action_publique_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_action_publique_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends le déclenchement et l’exercice de l’action publique : les acteurs, les conditions et les causes d’extinction.',
