...
// PAGE
// ============================================================================
class QuizHierarchiePageGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName = '/gpx/generalites/quiz/hierarchie';
  final String uid;
  final String email;

  const QuizHierarchiePageGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizHierarchiePageGPX> createState() => _QuizHierarchiePageGPXState();
}

class _QuizHierarchiePageGPXState extends State<QuizHierarchiePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_hierarchie';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_hierarchie_page',
