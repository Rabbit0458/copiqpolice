...
// PAGE
// ============================================================================
class QuizJuridictionsPageGPX extends StatefulWidget {
  ...
  @override
  State<QuizJuridictionsPageGPX> createState() => _QuizJuridictionsPageGPXState();
}

class _QuizJuridictionsPageGPXState extends State<QuizJuridictionsPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_juridiction';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_juridiction_page',
