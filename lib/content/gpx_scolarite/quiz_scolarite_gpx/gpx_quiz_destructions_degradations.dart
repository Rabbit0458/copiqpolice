...
// PAGE
// ============================================================================
class QuizDDDGPX extends StatefulWidget {
  ...
  const QuizDDDGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizDDDGPX> createState() => _QuizDDDGPXState();
}

class _QuizDDDGPXState extends State<QuizDDDGPX> with TickerProviderStateMixin {
  // Page & data
  ...
  static const _introHiddenKey = 'intro_gpx_destructions_degradations';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_destructions_degradations',
