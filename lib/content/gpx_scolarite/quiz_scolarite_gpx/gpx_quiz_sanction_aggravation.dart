...
// PAGE
// ============================================================================
class QuizSanctionAggravationGPX extends StatefulWidget {
  ...
  const QuizSanctionAggravationGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizSanctionAggravationGPX> createState() => _QuizSanctionAggravationGPXState();
}

class _QuizSanctionAggravationGPXState extends State<QuizSanctionAggravationGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_sanction_aggravation';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_sanction_aggravation',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            description: 'Identifie les circonstances aggravantes générales et spéciales, leur impact sur les peines et leur application en pratique.',
