...
class QuizAtteinteActionJusticeGPX extends StatefulWidget {
  ...
  @override
  State<QuizAtteinteActionJusticeGPX> createState() =>
      _QuizAtteinteActionJusticeGPXState();
}

class _QuizAtteinteActionJusticeGPXState
    extends State<QuizAtteinteActionJusticeGPX>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_atteintes_action_justice',
