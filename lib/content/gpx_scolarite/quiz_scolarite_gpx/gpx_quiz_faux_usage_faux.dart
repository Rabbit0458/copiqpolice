...
class QuizFauxUsageFauxGPX extends StatefulWidget {
  ...
  @override
  State<QuizFauxUsageFauxGPX> createState() => _QuizFauxUsageFauxGPXState();
}

class _QuizFauxUsageFauxGPXState extends State<QuizFauxUsageFauxGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_faux_usage_faux';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_faux_usage_faux',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_faux_usage_faux',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Identifie les infractions de faux : faux matériel, faux intellectuel, conditions d’incrimination, préjudice requis et sanctions.',
