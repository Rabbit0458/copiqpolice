...
// PAGE
// ============================================================================
class QuizCirculationRoutiereGPX extends StatefulWidget {
  ...
  const QuizCirculationRoutiereGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCirculationRoutiereGPX> createState() => _QuizCirculationRoutiereGPXState();
}

class _QuizCirculationRoutiereGPXState extends State<QuizCirculationRoutiereGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_circulation_routiere';
    ...
    try {
      final res = await _sb
          ...
          .insert({
            ...
            'mode': UserContextService.I.modeOrDefault,'module_name': 'Infractions à la circulation routière',
            'quiz_name': 'Infractions à la circulation routière',
            'score': 0,
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_circulation_routiere',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            description: 'Teste tes connaissances sur le Code de la route : infractions, sanctions, stupéfiants au volant, alcoolémie et procédures policières associées.',
