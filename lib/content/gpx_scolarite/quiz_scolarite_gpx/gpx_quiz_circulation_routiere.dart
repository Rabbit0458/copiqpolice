...
class QuizCirculationRoutiereGPX extends StatefulWidget {
  ...
  @override
  State<QuizCirculationRoutiereGPX> createState() =>
      _QuizCirculationRoutiereGPXState();
}
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_circulation_routiere',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Teste tes connaissances sur le Code de la route : infractions, sanctions, stupéfiants au volant, alcoolémie et procédures policières associées.',
