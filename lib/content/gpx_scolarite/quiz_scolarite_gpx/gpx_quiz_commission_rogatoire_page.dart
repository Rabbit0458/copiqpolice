...
class QuizCommissionRogatoirePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizCommissionRogatoirePageGPX> createState() =>
      _QuizCommissionRogatoirePageGPXState();
}

class _QuizCommissionRogatoirePageGPXState
    extends State<QuizCommissionRogatoirePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_commission_rogatoire';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_commission_rogatoire_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_commission_rogatoire_page',
