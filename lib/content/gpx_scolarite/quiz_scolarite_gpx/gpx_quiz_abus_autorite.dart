...
class QuizAbusAutoriteGPX extends StatefulWidget {
  ...
  @override
  State<QuizAbusAutoriteGPX> createState() => _QuizAbusAutoriteGPXState();
}

class _QuizAbusAutoriteGPXState extends State<QuizAbusAutoriteGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_abus_autorite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_abus_autorite',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_abus_autorite',
