...
class QuizEnquetePreliminairePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizEnquetePreliminairePageGPX> createState() =>
      _QuizEnquetePreliminairePageGPXState();
}

class _QuizEnquetePreliminairePageGPXState
    extends State<QuizEnquetePreliminairePageGPX>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_enquete_preliminaire_page',
