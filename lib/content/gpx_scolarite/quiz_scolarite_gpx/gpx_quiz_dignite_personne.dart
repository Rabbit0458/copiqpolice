...
class QuizDiginitePersonneGPX extends StatefulWidget {
  ...
  @override
  State<QuizDiginitePersonneGPX> createState() =>
      _QuizDiginitePersonneGPXState();
}

class _QuizDiginitePersonneGPXState extends State<QuizDiginitePersonneGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_dignite_personne';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_dignite_personne',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_dignite_personne',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Étudie les infractions portant atteinte à la dignité humaine : traite des êtres humains, proxénétisme, conditions de travail indignes.',
