...
class QuizCriminaliteOrganiseePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizCriminaliteOrganiseePageGPX> createState() =>
      _QuizCriminaliteOrganiseePageGPXState();
}

class _QuizCriminaliteOrganiseePageGPXState
    extends State<QuizCriminaliteOrganiseePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_criminalite_organisee';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_criminalite_organisee',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_criminalite_organisee',
