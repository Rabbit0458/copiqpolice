...
// PAGE
// ============================================================================
class QuizSanctionPluraliteGPX extends StatefulWidget {
  ...
  const QuizSanctionPluraliteGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizSanctionPluraliteGPX> createState() => _QuizSanctionPluraliteGPXState();
}

class _QuizSanctionPluraliteGPXState extends State<QuizSanctionPluraliteGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_sanction_pluralite';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_sanction_pluralite',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            description: 'Comprends les règles de cumul des peines : concours d’infractions, récidive, confusion et non-cumul.',
