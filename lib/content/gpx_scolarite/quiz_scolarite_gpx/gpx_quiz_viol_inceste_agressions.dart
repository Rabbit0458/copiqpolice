...
// PAGE
// ============================================================================
class QuizViolIncesteGPX extends StatefulWidget {
  ...
  const QuizViolIncesteGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizViolIncesteGPX> createState() => _QuizViolIncesteGPXState();
}

class _QuizViolIncesteGPXState extends State<QuizViolIncesteGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_viol_inceste_agressions';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_viol_inceste_agressions',
