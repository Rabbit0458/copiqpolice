...
class QuizLibertesPubliquesPageGPX extends StatefulWidget {
  ...
  @override
  State<QuizLibertesPubliquesPageGPX> createState() =>
      _QuizLibertesPubliquesPageGPXState();
}

class _QuizLibertesPubliquesPageGPXState
    extends State<QuizLibertesPubliquesPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_libertes_publiques';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_libertes_publiques_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_libertes_publiques_page',
