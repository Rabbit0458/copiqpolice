...
// PAGE
// ============================================================================
class QuizCrimesDelitsNationGPX extends StatefulWidget {
  ...
  const QuizCrimesDelitsNationGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCrimesDelitsNationGPX> createState() =>
      _QuizCrimesDelitsNationGPXState();
}

class _QuizCrimesDelitsNationGPXState extends State<QuizCrimesDelitsNationGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_crimes_delits_nation';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_crimes_delits_nation',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_crimes_delits_nation',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Étudie les infractions contre les intérêts fondamentaux de la nation : trahison, espionnage, terrorisme et atteintes aux institutions.',
