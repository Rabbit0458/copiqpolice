...
// PAGE
// ============================================================================
class QuizAtteinteInvolontaireGPX extends StatefulWidget {
  ...
  const QuizAtteinteInvolontaireGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteInvolontaireGPX> createState() => _QuizAtteinteInvolontaireGPXState();
}

class _QuizAtteinteInvolontaireGPXState extends State<QuizAtteinteInvolontaireGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_atteintes_involontaires';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_atteintes_involontaires',
