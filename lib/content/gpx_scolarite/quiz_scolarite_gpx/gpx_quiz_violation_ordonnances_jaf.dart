...
// PAGE
// ============================================================================
class QuizViolationOrdonnancesJafGPX extends StatefulWidget {
  ...
  const QuizViolationOrdonnancesJafGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizViolationOrdonnancesJafGPX> createState() => _QuizViolationOrdonnancesJafGPXState();
}

class _QuizViolationOrdonnancesJafGPXState extends State<QuizViolationOrdonnancesJafGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_violation_ordonnances_jaf';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_violation_ordonnances_jaf',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            title: 'Ordonnances JAF',
                            description: 'Comprends les ordonnances du juge aux affaires familiales et les infractions liées à leur violation : résidence, garde, pension alimentaire.',
