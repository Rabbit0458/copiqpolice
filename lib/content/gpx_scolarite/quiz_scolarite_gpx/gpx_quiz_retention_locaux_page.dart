...
class QuizRetentionLocauxPageGPX extends StatefulWidget {
  ...
  const QuizRetentionLocauxPageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizRetentionLocauxPageGPX> createState() => _QuizRetentionLocauxPageGPXState();
}

class _QuizRetentionLocauxPageGPXState extends State<QuizRetentionLocauxPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_retention_locaux';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_retention_locaux_page',
