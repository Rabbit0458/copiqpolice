...
// PAGE
// ============================================================================
class QuizLibertesPubliquesCollectivesPageGPX extends StatefulWidget {
  ...
  const QuizLibertesPubliquesCollectivesPageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizLibertesPubliquesCollectivesPageGPX> createState() =>
      _QuizLibertesPubliquesCollectivesPageGPXState();
}

class _QuizLibertesPubliquesCollectivesPageGPXState
    extends State<QuizLibertesPubliquesCollectivesPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_libertes_publiques_collectives';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_libertes_publiques_collectives_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_libertes_publiques_collectives_page',
