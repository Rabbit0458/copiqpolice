...
class QuizAtteinteAdministrationGPX extends StatefulWidget {
  ...
  @override
  State<QuizAtteinteAdministrationGPX> createState() =>
      _QuizAtteinteAdministrationGPXState();
}

class _QuizAtteinteAdministrationGPXState
    extends State<QuizAtteinteAdministrationGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_atteintes_administration';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_atteintes_administration',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_atteintes_administration',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Identifie les infractions commises contre l’administration : corruption, concussion, prise illégale d’intérêts.',
