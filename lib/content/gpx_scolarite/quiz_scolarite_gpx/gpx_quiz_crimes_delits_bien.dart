...
// PAGE
// ============================================================================
class QuizCrimesDelitsBiensGPX extends StatefulWidget {
  ...
  const QuizCrimesDelitsBiensGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCrimesDelitsBiensGPX> createState() =>
      _QuizCrimesDelitsBiensGPXState();
}

class _QuizCrimesDelitsBiensGPXState extends State<QuizCrimesDelitsBiensGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_crimes_delits_bien';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_crimes_delits_bien',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_crimes_delits_bien',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Identifie les infractions contre les biens : vol, escroquerie, abus de confiance, extorsion et leurs circonstances aggravantes.',
