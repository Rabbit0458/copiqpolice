...
// PAGE
// ============================================================================
class QuizNullitePageGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName = '/gpx/procedure_penale/quiz/nullite';
  final String uid;
  final String email;

  const QuizNullitePageGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizNullitePageGPX> createState() => _QuizNullitePageGPXState();
}

class _QuizNullitePageGPXState extends State<QuizNullitePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_nullite';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_nullite_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Nullités',
                                description:
                                    'Comprends le régime des nullités de procédure : nullités textuelles et substantielles, conditions, effets et moyens de les invoquer.',
