...
class QuizPersonnesFuitePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizPersonnesFuitePageGPX> createState() =>
      _QuizPersonnesFuitePageGPXState();
}

class _QuizPersonnesFuitePageGPXState extends State<QuizPersonnesFuitePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_personnes_fuite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_personnes_fuite',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_personnes_fuite',
