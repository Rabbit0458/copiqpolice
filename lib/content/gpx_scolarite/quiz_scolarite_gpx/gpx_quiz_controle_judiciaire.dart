...
// PAGE
// ============================================================================
class QuizControleJudiciairePageGPX extends StatefulWidget {
  ...
  const QuizControleJudiciairePageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizControleJudiciairePageGPX> createState() => _QuizControleJudiciairePageGPXState();
}

class _QuizControleJudiciairePageGPXState extends State<QuizControleJudiciairePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_controle_judiciaire';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_controle_judiciaire',
