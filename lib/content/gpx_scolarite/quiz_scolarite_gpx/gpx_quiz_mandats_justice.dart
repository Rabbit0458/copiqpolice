...
// PAGE
// ============================================================================
class QuizMandatsPageGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName = '/gpx/procedure_penale/quiz/mandats_justice';
  final String uid;
  final String email;

  const QuizMandatsPageGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizMandatsPageGPX> createState() => _QuizMandatsPageGPXState();
}

class _QuizMandatsPageGPXState extends State<QuizMandatsPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_mandats_justice';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_mandats_justice',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_mandats_justice',
