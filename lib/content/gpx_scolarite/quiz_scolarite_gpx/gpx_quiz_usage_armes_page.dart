...
// PAGE
// ============================================================================
class QuizUsageArmesPageGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName = '/gpx/generalites/quiz/usagearmes';
  final String uid;
  final String email;

  const QuizUsageArmesPageGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizUsageArmesPageGPX> createState() => _QuizUsageArmesPageGPXState();
}

class _QuizUsageArmesPageGPXState extends State<QuizUsageArmesPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_usage_armes';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_usage_armes_page',
