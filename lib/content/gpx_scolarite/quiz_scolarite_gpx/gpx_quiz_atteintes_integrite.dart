...
// PAGE
// ============================================================================
class QuizAtteinteIntegriteGPX extends StatefulWidget {
  ...
  const QuizAtteinteIntegriteGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteIntegriteGPX> createState() => _QuizAtteinteIntegriteGPXState();
}

class _QuizAtteinteIntegriteGPXState extends State<QuizAtteinteIntegriteGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_atteintes_integrite';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_atteintes_integrite',
