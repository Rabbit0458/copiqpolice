...
// PAGE
// ============================================================================
class QuizIntroductionGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName = '/gpx/libertes_publiques/quiz/introduction';
  final String uid;
  final String email;

  const QuizIntroductionGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizIntroductionGPX> createState() => _QuizIntroductionGPXState();
}

class _QuizIntroductionGPXState extends State<QuizIntroductionGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_introduction';
    ...
    try {
      final res = await _sb
          ...
          .insert({
            ...
            'module_name': 'Libertés publiques (introduction)',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_introduction',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Introduction',
                                description:
                                    'Pose les bases : structure de la procédure pénale, acteurs, principes directeurs et articulation entre les différentes phases.',
