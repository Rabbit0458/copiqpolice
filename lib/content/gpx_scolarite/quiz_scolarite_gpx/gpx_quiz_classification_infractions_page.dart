...
// PAGE
// ============================================================================
class QuizClassificationInfractionsPageGPX extends StatefulWidget {
  ...
  const QuizClassificationInfractionsPageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizClassificationInfractionsPageGPX> createState() => _QuizClassificationInfractionsPageGPXState();
}

class _QuizClassificationInfractionsPageGPXState extends State<QuizClassificationInfractionsPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_classification_infractions';
  String?
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_classification_infractions_page',
