...
// PAGE
// ============================================================================
class QuizResponsabilitePenalePageGPX extends StatefulWidget {
  ...
  const QuizResponsabilitePenalePageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizResponsabilitePenalePageGPX> createState() => _QuizResponsabilitePenalePageGPXState();
}

class _QuizResponsabilitePenalePageGPXState extends State<QuizResponsabilitePenalePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_responsabilite_penal_general';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_responsabilite_penal_general',
