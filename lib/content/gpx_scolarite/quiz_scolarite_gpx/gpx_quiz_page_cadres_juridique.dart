...
// PAGE
// ============================================================================
class QuizCadresPrincipalesPageGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName =
      '/gpx/procedure_penale/quiz/cadres_juridiques_principales';
  final String uid;
  final String email;

  const QuizCadresPrincipalesPageGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCadresPrincipalesPageGPX> createState() => _QuizCadresPrincipalesPageGPXState();
}

class _QuizCadresPrincipalesPageGPXState extends State<QuizCadresPrincipalesPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_page_cadres_juridique';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_page_cadres_juridique',
