...
// ============================================================================
class QuizInfractionsPageGPX extends StatefulWidget {
  ...
  @override
  State<QuizInfractionsPageGPX> createState() => _QuizInfractionsPageGPXState();
}

class _QuizInfractionsPageGPXState extends State<QuizInfractionsPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_infraction';
  String?
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_infraction_page',
