...
// PAGE
// ============================================================================
class QuizAtteinteVolontaireGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName =
      '/gpx/crimes_personne/quiz/atteintes_volontaires_vie';
  final String uid;
  final String email;

  const QuizAtteinteVolontaireGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteVolontaireGPX> createState() => _QuizAtteinteVolontaireGPXState();
}

class _QuizAtteinteVolontaireGPXState extends State<QuizAtteinteVolontaireGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_atteintes_volontaires';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_atteintes_volontaires',
