...
// PAGE
// ============================================================================
class QuizArmesMunitionsGPX extends StatefulWidget {
  ...
  @override
  State<QuizArmesMunitionsGPX> createState() => _QuizArmesMunitionsGPXState();
}

class _QuizArmesMunitionsGPXState extends State<QuizArmesMunitionsGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_armes_munitions';
    ...
    try {
      final res = await _sb
          ...
          .insert({
            ...
            'module_name': 'Classification des armes et des munitions',
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_armes_munitions_pages',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_armes_munitions_pages',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise la réglementation sur les armes : classification, autorisations, infractions liées à la détention et au port d’armes en France.',
