...
class QuizGarantiesLibertesPageGPX extends StatefulWidget {
  ...
  @override
  State<QuizGarantiesLibertesPageGPX> createState() =>
      _QuizGarantiesLibertesPageGPXState();
}

class _QuizGarantiesLibertesPageGPXState
    extends State<QuizGarantiesLibertesPageGPX>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_libertes_publiques_garanties_page',
