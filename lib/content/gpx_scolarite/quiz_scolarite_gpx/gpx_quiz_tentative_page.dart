...
class QuizTentativePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizTentativePageGPX> createState() => _QuizTentativePageGPXState();
}

class _QuizTentativePageGPXState extends State<QuizTentativePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_tentative';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_tentative_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_tentative_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Tentative',
                                description:
                                    'Comprends la tentative punissable : commencement d’exécution, désistement volontaire, infraction impossible et leur régime juridique.',
