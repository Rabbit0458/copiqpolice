...
// PAGE
// ============================================================================
class QuizDisparitionPageGPX extends StatefulWidget {
  ...
  @override
  State<QuizDisparitionPageGPX> createState() => _QuizDisparitionPageGPXState();
}

class _QuizDisparitionPageGPXState extends State<QuizDisparitionPageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_disparitions_inquietantes';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_disparitions_inquietantes',
