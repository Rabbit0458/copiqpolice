...
class QuizControleIdentitePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizControleIdentitePageGPX> createState() =>
      _QuizControleIdentitePageGPXState();
}

class _QuizControleIdentitePageGPXState
    extends State<QuizControleIdentitePageGPX>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_controle_identite',
