...
class QuizLegitimeDefensePageGPX extends StatefulWidget {
  ...
  @override
  State<QuizLegitimeDefensePageGPX> createState() =>
      _QuizLegitimeDefensePageGPXState();
}

class _QuizLegitimeDefensePageGPXState extends State<QuizLegitimeDefensePageGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_legitime_defense';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_legitime_defense_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_legitime_defense_page',
