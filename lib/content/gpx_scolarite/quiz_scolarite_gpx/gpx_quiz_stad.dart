...
// PAGE
// ============================================================================
class QuizStadGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName = '/gpx/crimes_biens/quiz/stad';
  final String uid;
  final String email;

  const QuizStadGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizStadGPX> createState() => _QuizStadGPXState();
}

class _QuizStadGPXState extends State<QuizStadGPX> with TickerProviderStateMixin {
  // Page & data
  ...
  static const _introHiddenKey = 'intro_gpx_stad';
