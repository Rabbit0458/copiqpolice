...
class QuizMiseEnDangerGPX extends StatefulWidget {
  ...
  @override
  State<QuizMiseEnDangerGPX> createState() => _QuizMiseEnDangerGPXState();
}

class _QuizMiseEnDangerGPXState extends State<QuizMiseEnDangerGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_mise_en_danger';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'gpx_quiz_mise_en_danger',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_mise_en_danger',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends l’infraction de mise en danger délibérée d’autrui : éléments constitutifs, distinction avec les infractions de résultat.',
