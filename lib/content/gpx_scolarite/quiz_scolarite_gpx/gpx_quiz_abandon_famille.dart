...
// PAGE
// ============================================================================
class QuizAbandonFamilleGPX extends StatefulWidget {
  ...
  const QuizAbandonFamilleGPX({super.key, required this.uid, required this.email});

  @override
  State<QuizAbandonFamilleGPX> createState() => _QuizAbandonFamilleGPXState();
}

class _QuizAbandonFamilleGPXState extends State<QuizAbandonFamilleGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_abandon_famille';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_abandon_famille',
