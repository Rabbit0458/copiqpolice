...
// PAGE
// ============================================================================
class QuizDispositionsApplicablesMineursGPX extends StatefulWidget {
  static const String grade = 'gpx';
  static const String routeName =
      '/gpx/procedure_penale/quiz/dispositions_applicables_mineurs';
  final String uid;
  final String email;

  const QuizDispositionsApplicablesMineursGPX({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizDispositionsApplicablesMineursGPX> createState() => _QuizDispositionsApplicablesMineursGPXState();
}

class _QuizDispositionsApplicablesMineursGPXState extends State<QuizDispositionsApplicablesMineursGPX>
  ...
  static const _introHiddenKey = 'intro_gpx_dispositions_applicables_mineurs';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'gpx_quiz_dispositions_applicables_mineurs',
