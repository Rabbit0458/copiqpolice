...
class QuizAtteinteActionJusticeGPXSchool extends StatefulWidget {
  ...
  const QuizAtteinteActionJusticeGPXSchool({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteActionJusticeGPXSchool> createState() =>
      _QuizAtteinteActionJusticeGPXSchoolState();
}

class _QuizAtteinteActionJusticeGPXSchoolState
    extends State<QuizAtteinteActionJusticeGPXSchool>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_atteintes_action_justice',
