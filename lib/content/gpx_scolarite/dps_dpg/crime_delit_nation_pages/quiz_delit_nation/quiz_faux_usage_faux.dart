...
class QuizFauxUsageFaux extends StatefulWidget {
  ...
  const QuizFauxUsageFaux({super.key, required this.uid, required this.email});

  @override
  State<QuizFauxUsageFaux> createState() => _QuizFauxUsageFauxState();
}

class _QuizFauxUsageFauxState extends State<QuizFauxUsageFaux>
