...
class QuizProbite extends StatefulWidget {
  ...
  const QuizProbite({super.key, required this.uid, required this.email});

  @override
  State<QuizProbite> createState() => _QuizProbiteState();
}

class _QuizProbiteState extends State<QuizProbite>
