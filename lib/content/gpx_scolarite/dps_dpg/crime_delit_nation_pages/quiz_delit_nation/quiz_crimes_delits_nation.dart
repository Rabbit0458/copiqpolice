...
// PAGE
// ============================================================================
class QuizCrimesDelitsNation extends StatefulWidget {
  static const String routeName =
      '/gpx/crime_delit_nation_pages/quiz/quiz_crimes_delits_nation';
  final String uid;
  final String email;

  const QuizCrimesDelitsNation({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCrimesDelitsNation> createState() => _QuizCrimesDelitsNationState();
}

class _QuizCrimesDelitsNationState extends State<QuizCrimesDelitsNation>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_crimes_delits_nation',
