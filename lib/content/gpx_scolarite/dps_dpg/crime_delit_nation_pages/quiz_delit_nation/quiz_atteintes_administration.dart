...
class QuizAtteinteAdministrationGPXSchool extends StatefulWidget {
  ...
  const QuizAtteinteAdministrationGPXSchool({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteAdministrationGPXSchool> createState() =>
      _QuizAtteinteAdministrationGPXSchoolState();
}

class _QuizAtteinteAdministrationGPXSchoolState
    extends State<QuizAtteinteAdministrationGPXSchool>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_atteintes_administration',
