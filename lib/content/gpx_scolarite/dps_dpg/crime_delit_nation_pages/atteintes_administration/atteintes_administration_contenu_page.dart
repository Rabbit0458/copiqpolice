...
class AtteintesAdministrationContenuPage extends StatelessWidget {
  const AtteintesAdministrationContenuPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/crime_delit_nation_pages/atteintes_administration/atteintes_administration_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_nation_pages/atteintes_administration/provocation_directe_rebellion',
            ),
          ),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx/nation/quiz/atteintes_administration',
            ),
          ),
