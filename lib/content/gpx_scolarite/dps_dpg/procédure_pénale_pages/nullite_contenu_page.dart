...
class PPNulliteActesProcedureContenuPage extends StatelessWidget {
  const PPNulliteActesProcedureContenuPage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/procédure_pénale_pages/pp_nullite_actes_procedure_contenu';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/procédure_pénale_pages/nullite_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
