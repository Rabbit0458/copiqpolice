...
class ControleMissionJudiciairePage extends StatelessWidget {
  const ControleMissionJudiciairePage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/procédure_pénale_pages/pp_controle_mission_pj_intro';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/procédure_pénale_pages/pp_controle_mission_pj_inspection_generale_justice',
            ),
          ),
          const SizedBox(height: 14),
