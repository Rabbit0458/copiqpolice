...
// PAGE
// ============================================================================
class QuizDetentionProvisoirePage extends StatefulWidget {
  static const String routeName =
      '/gpx/procedure_penale/quiz/detention_provisoire';
  final String uid;
  final String email;

  const QuizDetentionProvisoirePage({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizDetentionProvisoirePage> createState() =>
      _QuizDetentionProvisoirePageState();
}

class _QuizDetentionProvisoirePageState
    extends State<QuizDetentionProvisoirePage>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_detention_provisoire_page',
