...
// PAGE
// ============================================================================
class QuizDispositionsApplicablesMineurs extends StatefulWidget {
  static const String routeName =
      '/gpx/procedure_penale/quiz/dispositions_applicables_mineurs';
  final String uid;
  final String email;

  const QuizDispositionsApplicablesMineurs({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizDispositionsApplicablesMineurs> createState() =>
      _QuizDispositionsApplicablesMineursState();
}

class _QuizDispositionsApplicablesMineursState
    extends State<QuizDispositionsApplicablesMineurs>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_dispositions_applicables_mineurs',
