...
class QuizActionPubliquePage extends StatefulWidget {
  ...
  @override
  State<QuizActionPubliquePage> createState() => _QuizActionPubliquePageState();
}

class _QuizActionPubliquePageState extends State<QuizActionPubliquePage>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_action_publique_page',
