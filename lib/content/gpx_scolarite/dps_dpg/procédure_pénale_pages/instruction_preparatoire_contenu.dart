...
class InstructionContenuPage extends StatelessWidget {
  const InstructionContenuPage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/procédure_pénale_pages/pp_instruction_preparatoire_contenu';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/procédure_pénale_pages/instruction_preparatoire_contenu.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/procédure_pénale_pages/pp_instruction_preparatoire',
            ),
          ),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/procédure_pénale_pages/pp_detention_provisoire_contenu',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/procédure_pénale_pages/pp_dispositions_mineurs_instruction_contenu',
            ),
          ),
