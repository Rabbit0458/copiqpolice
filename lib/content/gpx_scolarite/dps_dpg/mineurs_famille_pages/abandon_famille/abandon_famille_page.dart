...
class AbandonFamillePage extends StatelessWidget {
  const AbandonFamillePage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/mineurs_famille_pages/abandon_famille';

  static const String _headerImage = 'assets/images/abandon_famille.jpeg';
    ...
    final items = <_Item>[
      _Item(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/abandon_famille/abandon_famille_page.dart",
          "f00001",
