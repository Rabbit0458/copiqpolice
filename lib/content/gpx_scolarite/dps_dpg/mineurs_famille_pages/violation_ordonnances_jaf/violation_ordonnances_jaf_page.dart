...
class ViolationOrdonnancesJafPage extends StatelessWidget {
  const ViolationOrdonnancesJafPage({super.key});
    ...
    final items = <_Item>[
      _Item(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/violation_ordonnances_jaf/violation_ordonnances_jaf_page.dart",
          "f00001",
