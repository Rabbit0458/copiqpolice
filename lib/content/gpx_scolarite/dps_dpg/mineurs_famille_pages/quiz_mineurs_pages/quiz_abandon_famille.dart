...
// PAGE
// ============================================================================
class QuizAbandonFamille extends StatefulWidget {
  static const String routeName =
      '/gpx_scolarite_pages/mineurs_famille_pages/abandon_famille/quiz_abandon_famille';
  final String uid;
  final String email;

  const QuizAbandonFamille({super.key, required this.uid, required this.email});

  @override
  State<QuizAbandonFamille> createState() => _QuizAbandonFamilleState();
}

class _QuizAbandonFamilleState extends State<QuizAbandonFamille>
