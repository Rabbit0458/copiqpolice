...
class QuizAutoriteParentale extends StatefulWidget {
  ...
  @override
  State<QuizAutoriteParentale> createState() => _QuizAutoriteParentaleState();
}

class _QuizAutoriteParentaleState extends State<QuizAutoriteParentale>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_autorite_parentale',
