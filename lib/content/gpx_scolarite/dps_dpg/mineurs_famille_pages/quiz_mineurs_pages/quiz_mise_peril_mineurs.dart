...
class QuizMisePerilMineur extends StatefulWidget {
  ...
  @override
  State<QuizMisePerilMineur> createState() => _QuizMisePerilMineurState();
}

class _QuizMisePerilMineurState extends State<QuizMisePerilMineur>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_mise_peril_mineurs',
