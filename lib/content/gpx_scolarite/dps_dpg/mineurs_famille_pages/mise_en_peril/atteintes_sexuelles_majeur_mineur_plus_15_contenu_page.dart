...
class AtteintesSexuellesMajeurMineurPlus15Page extends StatelessWidget {
  const AtteintesSexuellesMajeurMineurPlus15Page({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_plus_15_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
            ...
            children: [
              ...
              _NotaBox(
                title: ScolariteText.value(
                  "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_plus_15_contenu_page.dart",
                  "f00022",
                  "Repères (si violence/contrainte/menace/surprise)",
                ),
                bodySpans: [
                  TextSpan(
                    text: ScolariteText.value(
                      "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_plus_15_contenu_page.dart",
                      "f00023",
                      "Viol si pénétration ou acte bucco-génital — ",
                    ),
                  ),
                  TextSpan(
                    text: ScolariteText.value(
                ...
                bodySpans: [
                  ...
                  TextSpan(
                    text: ScolariteText.value(
                      "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_plus_15_contenu_page.dart",
                      "f00037",
                      "articles 222-22-3 et 222-23-2 du Code pénal",
                    ),
                    style: TextStyle(
                      color: _lawRed,
                      fontWeight: FontWeight.w900,
                  ...
                  TextSpan(
                    text: ScolariteText.value(
                      "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_plus_15_contenu_page.dart",
                      "f00040",
                      "articles 222-22-3 et 222-29-3 du Code pénal",
                    ),
                    style: TextStyle(
                      color: _lawRed,
                      fontWeight: FontWeight.w900,
              ...
              _SubTitle(
                ScolariteText.value(
                  "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_plus_15_contenu_page.dart",
                  "f00041",
                  "D) Une victime mineure de plus de quinze ans",
                ),
              ),
              _Paragraph(
                ScolariteText.value(
