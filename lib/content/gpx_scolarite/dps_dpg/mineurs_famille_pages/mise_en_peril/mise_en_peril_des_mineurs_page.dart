...
class MiseEnPerilDesMineursPage extends StatelessWidget {
  const MiseEnPerilDesMineursPage({super.key});
    ...
    final items = <_ModuleItem>[
      _ModuleItem(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/mise_en_peril_des_mineurs_page.dart",
          "f00001",
      ...
      _ModuleItem(
        ...
        route:
            '/gpx_scolarite_pages/mineurs_famille_pages/mise_en_peril/provocation_pedopornographie',
      ),
      _ModuleItem(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/mise_en_peril_des_mineurs_page.dart",
      ...
      _ModuleItem(
        ...
        route:
            '/gpx_scolarite_pages/mineurs_famille_pages/mise_en_peril/provocation_mineur_alcool',
      ),
      _ModuleItem(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/mise_en_peril_des_mineurs_page.dart",
      ...
      _ModuleItem(
        ...
        route:
            '/gpx_scolarite_pages/mineurs_famille_pages/mise_en_peril/soustraction_parent_obligations_legales',
      ),
      _ModuleItem(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/mise_en_peril_des_mineurs_page.dart",
        ...
        route:
            '/gpx_scolarite_pages/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_15',
      ),
      _ModuleItem(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/mise_en_peril_des_mineurs_page.dart",
        ...
        route:
            '/gpx_scolarite_pages/mineurs_famille_pages/mise_en_peril/atteintes_sexuelles_majeur_mineur_plus_15',
      ),
      _ModuleItem(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/mise_en_peril_des_mineurs_page.dart",
        ...
        route:
            '/gpx_scolarite_pages/mineurs_famille_pages/mise_en_peril/exploitation_image_porno_mineur',
      ),
      _ModuleItem(
        title: ScolariteText.value(
          "lib/content/gpx_scolarite/dps_dpg/mineurs_famille_pages/mise_en_peril/mise_en_peril_des_mineurs_page.dart",
        ...
        route:
            '/gpx_scolarite_pages/mineurs_famille_pages/mise_en_peril/propositions_sexuelles_mineur_15_en_ligne',
      ),
