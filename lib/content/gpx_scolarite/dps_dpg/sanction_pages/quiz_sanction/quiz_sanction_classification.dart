...
// PAGE
// ============================================================================
class QuizSanctionClassification extends StatefulWidget {
  static const String routeName =
      '/gpx/sanction/quiz/sanction_classification_peine';
  final String uid;
  final String email;

  const QuizSanctionClassification({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizSanctionClassification> createState() =>
      _QuizSanctionClassificationState();
}

class _QuizSanctionClassificationState extends State<QuizSanctionClassification>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_sanction_classification',
