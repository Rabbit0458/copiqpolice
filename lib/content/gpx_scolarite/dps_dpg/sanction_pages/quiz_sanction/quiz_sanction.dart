...
class QuizSanction extends StatefulWidget {
  ...
  const QuizSanction({super.key, required this.uid, required this.email});

  @override
  State<QuizSanction> createState() => _QuizSanctionState();
}

class _QuizSanctionState extends State<QuizSanction>
