...
class MoyenCryptologiePage extends StatelessWidget {
  const MoyenCryptologiePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/sanction_pages/causes_aggravation_sanction/moyen_cryptologie_page.dart",
            "f00001",
