...
class DelitFuitePage extends StatelessWidget {
  const DelitFuitePage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/infraction_circulation_routière_pages/delit_fuite_page.dart",
            "f00001",
            'Retour',
          ),
        ),
