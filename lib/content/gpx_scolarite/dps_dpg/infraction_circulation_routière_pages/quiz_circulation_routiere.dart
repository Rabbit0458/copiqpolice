...
// PAGE
// ============================================================================
class QuizCirculationRoutiere extends StatefulWidget {
  static const String routeName =
      '/gpx/infraction_circulation_routière_pages/quiz/quiz_circulation_routiere';
  final String uid;
  final String email;

  const QuizCirculationRoutiere({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCirculationRoutiere> createState() =>
      _QuizCirculationRoutiereState();
}

class _QuizCirculationRoutiereState extends State<QuizCirculationRoutiere>
