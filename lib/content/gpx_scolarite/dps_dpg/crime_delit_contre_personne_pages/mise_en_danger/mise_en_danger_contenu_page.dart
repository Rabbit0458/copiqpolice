...
class MiseEnDangerContenuPage extends StatelessWidget {
  const MiseEnDangerContenuPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/crime_delit_contre_personne_pages/mise_en_danger/mise_en_danger_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_contre_personne_pages/mise_en_danger/mise_en_danger_diffusion_informations',
            ),
          ),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_contre_personne_pages/mise_en_danger/non_assistance_personne_peril',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_contre_personne_pages/mise_en_danger/delaissement_personne_hors_etat',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_contre_personne_pages/mise_en_danger/non_obstacle_commission_crime_delit',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_contre_personne_pages/mise_en_danger/risque_cause_autrui',
            ),
          ),
