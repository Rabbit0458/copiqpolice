...
class AtteintesInvolontairesContenuPage extends StatelessWidget {
  const AtteintesInvolontairesContenuPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/crime_delit_contre_personne_pages/atteintes_involontaires/atteintes_involontaires_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_contre_personne_pages/atteintes_involontaires/participation_groupement_violent',
            ),
          ),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_contre_personne_pages/atteintes_involontaires/atteintes_volontaires_qualifiees_violences',
            ),
          ),
          const SizedBox(height: 14),
