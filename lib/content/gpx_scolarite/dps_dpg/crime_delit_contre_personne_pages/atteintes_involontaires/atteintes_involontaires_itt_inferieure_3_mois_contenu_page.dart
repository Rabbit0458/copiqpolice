...
class AtteintesInvolontairesIttInferieure3MoisPage extends StatelessWidget {
  ...
  static const String routeName =
      '/gpx_scolarite_pages/crime_delit_contre_personne_pages/atteintes_involontaires/atteintes_involontaires_itt_inferieure_3_mois';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              _Paragraph.rich([
                const TextSpan(text: "Hors les cas prévus par "),
                TextSpan(
          ...
          _ConditionCard(
            ...
            children: [
              _Paragraph.rich([
                const TextSpan(text: "Infractions prévues et réprimées par "),
                TextSpan(
                  text:
          ...
          _ConditionCard(
            ...
            children: [
              ...
              _NotaBox(
                bodySpans: [
                  const TextSpan(text: "Exemples de jurisprudence :\n"),
                  const TextSpan(
                    text:
              ...
              _NotaBox(
                bodySpans: [
                  const TextSpan(text: "Exemples (maire : lien indirect) :\n"),
                  const TextSpan(
                    text:
              ...
              const _SubTitle("C) Sur la personne d’autrui (victime)"),
              ...
              _Paragraph.rich([
                ...
                const TextSpan(text: " : atteinte sans I.T.T."),
              ]),
            ],
          ),
          ...
          _ConditionCard(
            ...
            children: [
              ...
              _Paragraph.rich([
                ...
                const TextSpan(text: " (aggravation de "),
                TextSpan(
          ...
          _ConditionCard(
            ...
            children: [
              ...
              _Paragraph.rich([
                ...
                const TextSpan(text: " : "),
                const TextSpan(text: "amende de 2e classe."),
              ]),
              const SizedBox(height: 8),

              _Paragraph.rich([
                const TextSpan(text: "• I.T.T. ≤ 3 mois (5e classe) — "),
                TextSpan(
                  text: "article R. 625-2 du Code pénal",
                  style: const TextStyle(
                    color: _lawRed,
                ...
                const TextSpan(text: " : "),
                const TextSpan(text: "amende de 5e classe."),
              ]),
              const SizedBox(height: 8),
              ...
              const _SubTitle("Responsabilité pénale des personnes morales"),
              _Paragraph.rich([
                const TextSpan(text: "Prévue notamment par "),
                TextSpan(
