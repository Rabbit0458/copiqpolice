...
// PAGE
// ============================================================================
class QuizViolInceste extends StatefulWidget {
  static const String routeName =
      '/gpx/crimes_personne/quiz/viol_inceste_agressions';
  final String uid;
  final String email;

  const QuizViolInceste({super.key, required this.uid, required this.email});

  @override
  State<QuizViolInceste> createState() => _QuizViolIncesteState();
}

class _QuizViolIncesteState extends State<QuizViolInceste>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_viol_inceste_agressions',
