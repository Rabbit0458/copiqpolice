...
class QuizMiseEnDanger extends StatefulWidget {
  ...
  const QuizMiseEnDanger({super.key, required this.uid, required this.email});

  @override
  State<QuizMiseEnDanger> createState() => _QuizMiseEnDangerState();
}

class _QuizMiseEnDangerState extends State<QuizMiseEnDanger>
