...
// PAGE
// ============================================================================
class QuizEnregistrementDiffusionImages extends StatefulWidget {
  static const String routeName =
      '/gpx/crimes_personne/quiz/enregistrement_diffusion_images';
  final String uid;
  final String email;

  const QuizEnregistrementDiffusionImages({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizEnregistrementDiffusionImages> createState() =>
      _QuizEnregistrementDiffusionImagesState();
}

class _QuizEnregistrementDiffusionImagesState
    extends State<QuizEnregistrementDiffusionImages>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_enregistrement_diffusion_images',
