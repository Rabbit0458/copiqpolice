...
// PAGE
// ============================================================================
class QuizAtteinteVolontaire extends StatefulWidget {
  static const String routeName =
      '/gpx/crimes_personne/quiz/atteintes_volontaires_vie';
  final String uid;
  final String email;

  const QuizAtteinteVolontaire({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteVolontaire> createState() => _QuizAtteinteVolontaireState();
}

class _QuizAtteinteVolontaireState extends State<QuizAtteinteVolontaire>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_atteintes_volontaires',
