...
class SubstancePourViolOuAgressionPage extends StatelessWidget {
  const SubstancePourViolOuAgressionPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/crime_delit_contre_personne_pages/viol_inceste_agressions/substance_pour_viol_ou_agression_page.dart",
            "f00001",
