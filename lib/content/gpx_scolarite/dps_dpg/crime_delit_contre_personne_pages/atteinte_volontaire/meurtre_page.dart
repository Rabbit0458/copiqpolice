...
class MeurtrePage extends StatelessWidget {
  const MeurtrePage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/crime_delit_contre_personne_pages/atteintes_volontaires_vie/meurtre';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/crime_delit_contre_personne_pages/atteinte_volontaire/meurtre_page.dart",
            "f00001",
            'Retour',
          ),
        ),
