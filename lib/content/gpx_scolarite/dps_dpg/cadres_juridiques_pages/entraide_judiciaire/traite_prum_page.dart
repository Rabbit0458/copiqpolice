...
class TraitePrumPage extends StatelessWidget {
  const TraitePrumPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/entraide_judiciaire/traite_prum_page.dart",
            "f00001",
            'Retour',
          ),
