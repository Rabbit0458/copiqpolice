...
class PersonnesFuiteTechniqueSpecialesGpxSchool extends StatelessWidget {
  const PersonnesFuiteTechniqueSpecialesGpxSchool({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/personnes_en_fuite/personnes_fuite_techniques_speciales_gpx_school.dart",
            "f00001",
