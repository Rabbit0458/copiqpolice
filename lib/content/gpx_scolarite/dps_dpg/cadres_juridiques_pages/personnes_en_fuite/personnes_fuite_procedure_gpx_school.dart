...
class PersonnesFuiteProcedureGpxSchool extends StatelessWidget {
  const PersonnesFuiteProcedureGpxSchool({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/personnes_en_fuite/personnes_fuite_procedure_gpx_school.dart",
            "f00001",
            'Art. 74-2 – Procédure',
          ),
