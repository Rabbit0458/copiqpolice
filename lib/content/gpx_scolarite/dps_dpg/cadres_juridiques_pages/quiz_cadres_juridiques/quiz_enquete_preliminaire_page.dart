...
class QuizEnquetePreliminairePage extends StatefulWidget {
  ...
  const QuizEnquetePreliminairePage({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizEnquetePreliminairePage> createState() =>
      _QuizEnquetePreliminairePageState();
}

class _QuizEnquetePreliminairePageState
    extends State<QuizEnquetePreliminairePage>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_enquete_preliminaire_page',
