...
class QuizControleIdentitePage extends StatefulWidget {
  ...
  const QuizControleIdentitePage({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizControleIdentitePage> createState() =>
      _QuizControleIdentitePageState();
}

class _QuizControleIdentitePageState extends State<QuizControleIdentitePage>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_controle_identite',
