...
class CommissionRogatoireContenuPage extends StatelessWidget {
  ...
  static const String routeName =
      '/gpx/cadres_juridiques/commission_rogatoire_contenu';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx/cadres_juridiques/commission_rogatoire/chapitre1',
            ),
          ),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx/cadres_juridiques/commission_rogatoire/perquisitions_fouilles',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx/cadres_juridiques/commission_rogatoire/mandat_recherche',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx/cadres_juridiques/commission_rogatoire/requisitions',
            ),
          ),
