...
class FlagrantDelitDomainePage extends StatelessWidget {
  const FlagrantDelitDomainePage({super.key});

  static const String routeName =
      '/gpx/cadres_juridiques/enquete_flagrant_delit/chapitre2';
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              ...
              const _SubTitle('1. Les agents diplomatiques et assimilés'),
              ...
              const _SubTitle('2. Les fonctionnaires consulaires'),
              const _Paragraph.rich([
                TextSpan(
                  text:
              ...
              const _SubTitle('4. Le président de la République'),
              const _Paragraph.rich([
                TextSpan(
                  text:
              ...
              const _SubTitle('5. Les membres du Parlement'),
              const _Paragraph.rich([
                TextSpan(
                  text:
          ...
          _ConditionCard(
            ...
            children: [
              ...
              const _SubTitle('1. Locaux diplomatiques et consulaires'),
              const _BulletPoint(
                text:
