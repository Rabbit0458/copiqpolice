...
/// ===================================================================
class FlagrantDelitPanoramaPage extends StatelessWidget {
  const FlagrantDelitPanoramaPage({super.key});

  static const String routeName =
      '/gpx/cadres_juridiques/enquete_flagrant_delit/intro';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/flagrant_delit/flagrant_delit_panorama_page.dart",
            "f00001",
            'Retour',
          ),
        ),
            ...
            children: [
              ...
              _NotaBox(
                title: ScolariteText.value(
                  "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/flagrant_delit/flagrant_delit_panorama_page.dart",
                  "f00054",
                  'Prudence dans l’usage de la flagrance',
                ),
                bodySpans: [
                  TextSpan(
                    text:
