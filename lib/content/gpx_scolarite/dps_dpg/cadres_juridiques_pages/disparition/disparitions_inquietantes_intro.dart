...
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers DisparitionContenuPage
///  ✅ Bouton retour réutilisable : CopiqHeroBackButton
/// ==============================================================
class DisparitionIntroPage extends StatefulWidget {
  const DisparitionIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName =
      '/gpx/cadres_juridiques/disparitions_inquietantes_intro';

  @override
  State<DisparitionIntroPage> createState() => _DisparitionIntroPageState();
}

class _DisparitionIntroPageState extends State<DisparitionIntroPage>
  ...
  static const String _kTargetRouteName = DisparitionContenuPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/disparition/disparitions_inquietantes_intro.dart",
    "f00001",
                  ...
                  FadeTransition(
                    ...
                    child: Text(
                      ScolariteText.value(
                        "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/disparition/disparitions_inquietantes_intro.dart",
                        "f00002",
                        "Comprendre les disparitions inquiétantes.",
                      ),
...
/// ------------------------------------------------------------------
/// Shim de redirection vers la route cible (DisparitionContenuPage)
/// ------------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_DisparitionIntroPageState._kTargetRouteName),
    );
