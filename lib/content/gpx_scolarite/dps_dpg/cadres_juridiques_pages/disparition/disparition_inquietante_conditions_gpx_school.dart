...
class DisparitionInquietanteConditionsGpxSchool extends StatelessWidget {
  const DisparitionInquietanteConditionsGpxSchool({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/disparition/disparition_inquietante_conditions_gpx_school.dart",
            "f00001",
