...
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers CadresEnqueteContenuPage
///  ✅ Bouton retour réutilisable : CopiqHeroBackButton
/// ==============================================================
class CadresEnqueteIntroPage extends StatefulWidget {
  const CadresEnqueteIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/cadres_enquete_intro';

  @override
  State<CadresEnqueteIntroPage> createState() => _CadresEnqueteIntroPageState();
}

class _CadresEnqueteIntroPageState extends State<CadresEnqueteIntroPage>
  ...
  static const String _kTargetRouteName = CadresEnqueteContenuPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/cadres_enquete/cadres_enquete_intro_page.dart",
    "f00001",
...
/// ------------------------------------------------------------------
/// Shim de redirection vers la route cible (CadresEnqueteContenuPage)
/// ------------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_CadresEnqueteIntroPageState._kTargetRouteName),
    );
