...
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers MortInconnueContenuPage
///  ✅ Bouton retour réutilisable : CopiqHeroBackButton
/// ==============================================================
class MortInconnueIntroductionPage extends StatefulWidget {
  const MortInconnueIntroductionPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/mort_inconnue_intro';

  @override
  State<MortInconnueIntroductionPage> createState() =>
      _MortInconnueIntroPageState();
}

class _MortInconnueIntroPageState extends State<MortInconnueIntroductionPage>
  ...
  static const String _kTargetRouteName = MortInconnueContenuPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/mort_inconnue/mort_inconnue_page_intro.dart",
    "f00001",
                  ...
                  FadeTransition(
                    ...
                    child: Text(
                      ScolariteText.value(
                        "lib/content/gpx_scolarite/dps_dpg/cadres_juridiques_pages/mort_inconnue/mort_inconnue_page_intro.dart",
                        "f00002",
                        "Les dispositions des quatre premiers alinéas sont également applicables en cas de découverte d'une personne grièvement blessée",
                      ),
...
/// ------------------------------------------------------------------
/// Shim de redirection vers la route cible (MortInconnueContenuPage)
/// ------------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_MortInconnueIntroPageState._kTargetRouteName),
    );
