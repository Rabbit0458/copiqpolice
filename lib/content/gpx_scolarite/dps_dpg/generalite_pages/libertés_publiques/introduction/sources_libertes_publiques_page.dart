...
class SourcesLibertesPubliquesPage extends StatelessWidget {
  ...
  static const String routeName =
      '/gpx/generalites/libertes_publiques/introduction/sources';
        ...
        children: [
              ...
              _BulletPoint.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/introduction/sources_libertes_publiques_page.dart",
                    "f00022",
                    'La théorie du droit naturel et du contrat social : ',
                  ),
                  style: TextStyle(fontWeight: FontWeight.w700),
                ),
                TextSpan(
              ...
              _BulletPoint.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/introduction/sources_libertes_publiques_page.dart",
                    "f00027",
                    'La philosophie des Lumières (XVIIIᵉ siècle) : ',
                  ),
                  style: TextStyle(fontWeight: FontWeight.w700),
                ),
                TextSpan(
          ...
          _HypoCard(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/introduction/sources_libertes_publiques_page.dart",
              "f00032",
              '1.1.2 — Les sources juridiques avant 1789',
            ),
            cardColor: cardColor,
            accent: accentColor,
            titleColor: titleColor,
          ...
          _HypoCard(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/introduction/sources_libertes_publiques_page.dart",
              "f00082",
              '1.3 — L’évolution postérieure (1789–1958)',
            ),
            cardColor: cardColor,
            accent: accentColor,
            titleColor: titleColor,
              ...
              _BulletPoint.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/introduction/sources_libertes_publiques_page.dart",
                    "f00088",
                    'Les projets de 1793 (Girondins, Montagnards) : ',
                  ),
                  style: TextStyle(fontWeight: FontWeight.w700),
                ),
                TextSpan(
          ...
          _NotaBox(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/introduction/sources_libertes_publiques_page.dart",
              "f00106",
              'Chapitre 2 — Les sources actuelles des libertés publiques',
            ),
            bodySpans: [
              TextSpan(
                text:
