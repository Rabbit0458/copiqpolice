...
/// ===================================================================
class LiberteAllerVenirDetailPage extends StatelessWidget {
  const LiberteAllerVenirDetailPage({super.key});

  static const String routeName =
      '/gpx/generalites/libertes_publiques/individuelles/liberte_aller_venir_detail';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/liberte_aller_venir_detail_page.dart",
            "f00001",
