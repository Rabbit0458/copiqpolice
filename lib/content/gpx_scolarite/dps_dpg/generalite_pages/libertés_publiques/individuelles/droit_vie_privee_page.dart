...
/// ===================================================================
class DroitViePriveePage extends StatelessWidget {
  const DroitViePriveePage({super.key});

  static const String routeName =
      '/gpx/generalites/libertes_publiques/individuelles/droit_vie_privee';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/droit_vie_privee_page.dart",
            "f00001",
        ...
        children: [
          ...
          _NotaBox(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/droit_vie_privee_page.dart",
              "f00025",
              "Enjeu opérationnel pour les forces de l’ordre",
            ),
            bodySpans: [
              TextSpan(
                text:
              ...
              _BulletPoint.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/droit_vie_privee_page.dart",
                    "f00145",
                    "de la formation et de la pédagogie des agents.",
                  ),
                ),
              ]),
              const SizedBox(height: 4),
              ...
              _Paragraph.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/droit_vie_privee_page.dart",
                    "f00280",
                    "Sont considérés comme des domiciles, notamment :",
                  ),
                  style: TextStyle(color: textColor),
                ),
              ]),
              ...
              _BulletPoint.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/droit_vie_privee_page.dart",
                    "f00291",
                    "le logement vide de meubles entre deux locations ;",
                  ),
                ),
              ]),
              _BulletPoint.rich([
              ...
              _BulletPoint.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/droit_vie_privee_page.dart",
                    "f00296",
                    "le local exclusivement réservé à la vente ;",
                  ),
                ),
              ]),
              _BulletPoint.rich([
            ...
            children: [
              ...
              _NotaBox(
                title: ScolariteText.value(
                  "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/individuelles/droit_vie_privee_page.dart",
                  "f00436",
                  "Réflexe opérationnel pour l’agent",
                ),
                bodySpans: [
                  TextSpan(
                    text:
