  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/garanties/recours_non_juridictionnels_page.dart",
            "f00001",
        ...
        children: [
          ...
          _HypoCard(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/garanties/recours_non_juridictionnels_page.dart",
              "f00009",
              'Chapitre 1 — Les recours à caractère administratif',
            ),
            cardColor: cardColor,
            accent: accentColor,
          ...
          _HypoCard(
            title: ScolariteText.value(
              "lib/content/gpx_scolarite/dps_dpg/generalite_pages/libertés_publiques/garanties/recours_non_juridictionnels_page.dart",
              "f00021",
              'Chapitre 2 — Les recours à caractère politique',
            ),
            cardColor: cardColor,
            accent: accentColor,
            titleColor: titleColor,
