// lib/gpx_scolarite_pages/generalite_pages/LibertesPubliques_intro_page.dart
import 'dart:async';
...
///  Adapté depuis ta page "Classification" pour ouvrir LibertesPubliquesPage
///
///  ✅ Une SEULE image de fond (zéro doublon)
///  ✅ Adaptation parfaite : fitHeight + alignment ajusté
///  ✅ Titre "écriture IA" + glow
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers LibertesPubliquesPage
///  ✅ Minimaliste, moderne, 2025
///  ✅ Compatible Flutter 3.24+ (Color.withValues)
///
///  🔧 Où modifier RAPIDEMENT :
///   - _kBackgroundPath : chemin de l'image
///   - _kTargetRouteName : route de la page contenu (LibertesPubliquesPage.routeName)
///   - _kBackgroundAlignment : cadrage vertical
///   - _kFit : BoxFit.fitHeight / cover
/// ==============================================================
class LibertesPubliquesIntroPage extends StatefulWidget {
  const LibertesPubliquesIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/libertespubliques_intro';

  @override
  State<LibertesPubliquesIntroPage> createState() =>
      _LibertesPubliquesIntroPageState();
}

class _LibertesPubliquesIntroPageState extends State<LibertesPubliquesIntroPage>
  ...
  static const String _kTargetRouteName =
      LibertesPubliquesContenuPage.routeName;
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          // Bouton retour (toujours au-dessus de l’image, sous le contenu)
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible (LibertesPubliquesPage)
// --------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(context).pushReplacementNamed(
        _LibertesPubliquesIntroPageState._kTargetRouteName,
      ),
    );
