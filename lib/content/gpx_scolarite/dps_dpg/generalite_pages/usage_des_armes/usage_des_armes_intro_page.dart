// lib/gpx_scolarite_pages/generalite_pages/UsageArmes_intro_page.dart
import 'dart:async';
...
///  Adapté depuis ta page "Classification" pour ouvrir UsageArmesPage
///
///  ✅ Une SEULE image de fond (zéro doublon)
///  ✅ Adaptation parfaite : fitHeight + alignment ajusté
///  ✅ Titre "écriture IA" + glow
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers UsageArmesPage
///  ✅ Minimaliste, moderne, 2025
///  ✅ Compatible Flutter 3.24+ (Color.withValues)
///
///  🔧 Où modifier RAPIDEMENT :
///   - _kBackgroundPath : chemin de l'image
///   - _kTargetRouteName : route de la page contenu (UsageArmesPage.routeName)
///   - _kBackgroundAlignment : cadrage vertical
///   - _kFit : BoxFit.fitHeight / cover
/// ==============================================================
class UsageArmesIntroPage extends StatefulWidget {
  const UsageArmesIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/usagedesarmes_intro';

  @override
  State<UsageArmesIntroPage> createState() => _UsageArmesIntroPageState();
}

class _UsageArmesIntroPageState extends State<UsageArmesIntroPage>
  ...
  static const String _kTargetRouteName = UsageArmesPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/usage_des_armes/usage_des_armes_intro_page.dart",
    "f00001",
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible (UsageArmesPage)
// --------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () =>
          Navigator.of(context).pushReplacementNamed(UsageArmesPage.routeName),
    );
