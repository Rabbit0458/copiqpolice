...
///  Adapté depuis ta page "Classification" pour ouvrir TentativePage
///
///  ✅ Une SEULE image de fond (zéro doublon)
///  ✅ Adaptation parfaite : fitHeight + alignment ajusté
///  ✅ Titre "écriture IA" + glow
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers TentativePage
///  ✅ Minimaliste, moderne, 2025
///  ✅ Compatible Flutter 3.24+ (Color.withValues)
///
///  🔧 Où modifier RAPIDEMENT :
///   - _kBackgroundPath : chemin de l'image
///   - _kTargetRouteName : route de la page contenu (TentativePage.routeName)
///   - _kBackgroundAlignment : cadrage vertical
///   - _kFit : BoxFit.fitHeight / cover
/// ==============================================================
class TentativeIntroPage extends StatefulWidget {
  const TentativeIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/tentative_intro';

  @override
  State<TentativeIntroPage> createState() => _TentativeIntroPageState();
}

class _TentativeIntroPageState extends State<TentativeIntroPage>
  ...
  static const String _kTargetRouteName = TentativeContenuPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/tentative/tentative_intro_page.dart",
    "f00001",
    'LA TENTATIVE',
  );
  int _typedCount = 0;
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible (TentativePage)
// --------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_TentativeIntroPageState._kTargetRouteName),
    );
