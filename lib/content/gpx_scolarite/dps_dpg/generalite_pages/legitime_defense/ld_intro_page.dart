// lib/gpx_scolarite_pages/generalite_pages/LegitimeDefense_intro_page.dart
import 'dart:async';
...
///  Adapté depuis ta page "Classification" pour ouvrir LegitimeDefensePage
///
///  ✅ Une SEULE image de fond (zéro doublon)
///  ✅ Adaptation parfaite : fitHeight + alignment ajusté
///  ✅ Titre "écriture IA" + glow
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers LegitimeDefensePage
///  ✅ Minimaliste, moderne, 2025
///  ✅ Compatible Flutter 3.24+ (Color.withValues)
///
///  🔧 Où modifier RAPIDEMENT :
///   - _kBackgroundPath : chemin de l'image
///   - _kTargetRouteName : route de la page contenu (LegitimeDefensePage.routeName)
///   - _kBackgroundAlignment : cadrage vertical
///   - _kFit : BoxFit.fitHeight / cover
/// ==============================================================
class LegitimeDefenseIntroPage extends StatefulWidget {
  const LegitimeDefenseIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/legitimedefense_intro';

  @override
  State<LegitimeDefenseIntroPage> createState() =>
      _LegitimeDefenseIntroPageState();
}

class _LegitimeDefenseIntroPageState extends State<LegitimeDefenseIntroPage>
  ...
  static const String _kTargetRouteName = LdContenuPage.routeName;
...
/// ===================================================================
///  BOUTON RETOUR RÉUTILISABLE — COPIQ HERO BACK BUTTON
/// ===================================================================
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible (LegitimeDefensePage)
// --------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_LegitimeDefenseIntroPageState._kTargetRouteName),
    );
