// lib/gpx_scolarite_pages/generalite_pages/infraction_intro_page.dart
import 'dart:async';
...
///  Adapté depuis ta page "Classification" pour ouvrir InfractionPage
///
///  ✅ Une SEULE image de fond (zéro doublon)
///  ✅ Adaptation parfaite : fitHeight + alignment ajusté
///  ✅ Titre "écriture IA" + glow
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers InfractionPage
///  ✅ Minimaliste, moderne, 2025
///  ✅ Compatible Flutter 3.24+ (Color.withValues)
///
///  🔧 Où modifier RAPIDEMENT :
///   - _kBackgroundPath : chemin de l'image
///   - _kTargetRouteName : route de la page contenu (InfractionPage.routeName)
///   - _kBackgroundAlignment : cadrage vertical
///   - _kFit : BoxFit.fitHeight / cover
/// ==============================================================
class InfractionIntroPage extends StatefulWidget {
  const InfractionIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/infraction_intro';

  @override
  State<InfractionIntroPage> createState() => _InfractionIntroPageState();
}

class _InfractionIntroPageState extends State<InfractionIntroPage>
  ...
  static const String _kTargetRouteName = InfractionContenuPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/infraction/infraction_intro_page.dart",
    "f00001",
    'L’INFRACTION',
  );
  int _typedCount = 0;
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible (InfractionPage)
// --------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_InfractionIntroPageState._kTargetRouteName),
    );
