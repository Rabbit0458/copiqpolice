// lib/gpx_scolarite_pages/generalite_pages/Complicite_intro_page.dart
import 'dart:async';
...
///  Adapté depuis ta page "Classification" pour ouvrir ComplicitePage
///
///  ✅ Une SEULE image de fond (zéro doublon)
///  ✅ Adaptation parfaite : fitHeight + alignment ajusté
///  ✅ Titre "écriture IA" + glow
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers ComplicitePage
///  ✅ Minimaliste, moderne, 2025
///  ✅ Compatible Flutter 3.24+ (Color.withValues)
///
///  🔧 Où modifier RAPIDEMENT :
///   - _kBackgroundPath : chemin de l'image
///   - _kTargetRouteName : route de la page contenu (ComplicitePage.routeName)
///   - _kBackgroundAlignment : cadrage vertical
///   - _kFit : BoxFit.fitHeight / cover
/// ==============================================================
class CompliciteIntroPage extends StatefulWidget {
  const CompliciteIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/gpx/generalites/complicite_intro';

  @override
  State<CompliciteIntroPage> createState() => _CompliciteIntroPageState();
}

class _CompliciteIntroPageState extends State<CompliciteIntroPage>
  ...
  static const String _kTargetRouteName = CompliciteContenuPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/gpx_scolarite/dps_dpg/generalite_pages/complicite/complicite_intro_page.dart",
    "f00001",
    'LA COMPLICITÉ',
  );
  int _typedCount = 0;
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          // 2) Voile lisibilité AU-DESSUS de l'image
          const DecoratedBox(
          ...
          // 4) Bouton RETOUR tout en haut de la pile (cliquable)
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible (ComplicitePage)
// --------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_CompliciteIntroPageState._kTargetRouteName),
    );
