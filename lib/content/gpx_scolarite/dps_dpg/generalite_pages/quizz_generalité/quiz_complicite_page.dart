...
class QuizComplicitePage extends StatefulWidget {
  ...
  const QuizComplicitePage({super.key, required this.uid, required this.email});

  @override
  State<QuizComplicitePage> createState() => _QuizComplicitePageState();
}

class _QuizComplicitePageState extends State<QuizComplicitePage>
