...
// PAGE
// ============================================================================
class QuizGeneralitePage extends StatefulWidget {
  static const String routeName =
      '/gpx/procedure_penale/quiz/generalité_principales';
  final String uid;
  final String email;

  const QuizGeneralitePage({super.key, required this.uid, required this.email});

  @override
  State<QuizGeneralitePage> createState() => _QuizGeneralitePageState();
}

class _QuizGeneralitePageState extends State<QuizGeneralitePage>
