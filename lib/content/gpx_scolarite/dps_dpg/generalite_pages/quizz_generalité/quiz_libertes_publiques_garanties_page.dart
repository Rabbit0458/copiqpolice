...
// PAGE
// ============================================================================
class QuizGarantiesLibertesPage extends StatefulWidget {
  ...
  const QuizGarantiesLibertesPage({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizGarantiesLibertesPage> createState() =>
      _QuizGarantiesLibertesPageState();
}

class _QuizGarantiesLibertesPageState extends State<QuizGarantiesLibertesPage>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_libertes_publiques_garanties_page',
