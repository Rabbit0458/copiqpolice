...
class QuizTentativePage extends StatefulWidget {
  ...
  const QuizTentativePage({super.key, required this.uid, required this.email});

  @override
  State<QuizTentativePage> createState() => _QuizTentativePageState();
}

class _QuizTentativePageState extends State<QuizTentativePage>
