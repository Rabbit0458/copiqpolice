...
class ClassificationInfractionsPage extends StatefulWidget {
  const ClassificationInfractionsPage({super.key});

  // Route actuelle de la page (si vous naviguez ici depuis ailleurs)
  static const String routeName =
      '/gpx/generalites/classification_infractions_contenu';

  @override
  State<ClassificationInfractionsPage> createState() =>
      _ClassificationInfractionsPageState();
}

class _ClassificationInfractionsPageState
    extends State<ClassificationInfractionsPage>
  ...
  static const String _kTargetRouteName =
      ClassificationInfractionsContenuPage.routeName;
