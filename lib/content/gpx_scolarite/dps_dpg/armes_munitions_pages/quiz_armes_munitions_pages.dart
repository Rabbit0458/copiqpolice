...
// PAGE
// ============================================================================
class QuizArmesMunitions extends StatefulWidget {
  static const String routeName =
      '/gpx/armes_munitions_pages/quiz/quiz_armes_munitions_pages';
  final String uid;
  final String email;

  const QuizArmesMunitions({super.key, required this.uid, required this.email});

  @override
  State<QuizArmesMunitions> createState() => _QuizArmesMunitionsState();
}

class _QuizArmesMunitionsState extends State<QuizArmesMunitions>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_armes_munitions_pages',
