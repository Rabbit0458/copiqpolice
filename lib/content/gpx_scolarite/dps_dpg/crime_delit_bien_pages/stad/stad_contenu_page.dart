...
class StadContenuPage extends StatelessWidget {
  ...
  static const String routeName =
      '/gpx_scolarite_pages/crime_delit_bien_pages/stad';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_bien_pages/stad/acces_maintien_frauduleux',
            ),
          ),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_bien_pages/stad/association_malfaiteurs_informatique',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_bien_pages/stad/donnees_adaptees_commettre_infractions',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/crime_delit_bien_pages/stad/introduction_suppression_modification_donnees',
            ),
          ),
          ...
          _ModuleCard(
            ...
            textMain: textMain,
            textSoft: textSoft,
            onTap: () => _openRoute(context, '/gpx/crimes_biens/quiz/stad'),
          ),
