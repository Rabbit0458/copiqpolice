...
class DiffusionProcedesFabricationEnginsDestructionPage
  ...
  const DiffusionProcedesFabricationEnginsDestructionPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: [
              const _SubTitle("A) Des moyens de diffusion"),
              const _Paragraph(
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: [
              const _SubTitle("A) Connaissance du risque lié à la diffusion"),
              const _Paragraph(
              ...
              const SizedBox(height: 12),
              const _SubTitle("B) Diffusion sciemment d’un mode d’emploi"),
              const _Paragraph(
