...
// PAGE
// ============================================================================
class QuizRecelNonJustification extends StatefulWidget {
  static const String routeName =
      '/gpx/crimes_biens/quiz/recel_non_justification';
  final String uid;
  final String email;

  const QuizRecelNonJustification({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizRecelNonJustification> createState() =>
      _QuizRecelNonJustificationState();
}

class _QuizRecelNonJustificationState extends State<QuizRecelNonJustification>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_recel_non_justification',
