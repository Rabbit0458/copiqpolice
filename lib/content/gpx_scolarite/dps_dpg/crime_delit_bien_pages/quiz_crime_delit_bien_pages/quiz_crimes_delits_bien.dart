...
// PAGE
// ============================================================================
class QuizCrimesDelitsBiens extends StatefulWidget {
  static const String routeName =
      '/gpx/crime_delit_nation_pages/quiz/quiz_crimes_delits_bien';
  final String uid;
  final String email;

  const QuizCrimesDelitsBiens({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCrimesDelitsBiens> createState() => _QuizCrimesDelitsBiensState();
}

class _QuizCrimesDelitsBiensState extends State<QuizCrimesDelitsBiens>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_crimes_delits_bien',
