...
// PAGE
// ============================================================================
class QuizDDD extends StatefulWidget {
  static const String routeName =
      '/gpx/crimes_biens/quiz/destructions_degradations';
  final String uid;
  final String email;

  const QuizDDD({super.key, required this.uid, required this.email});

  @override
  State<QuizDDD> createState() => _QuizDDDState();
}

class _QuizDDDState extends State<QuizDDD> with TickerProviderStateMixin {
  // Page & data
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_destructions_degradations',
