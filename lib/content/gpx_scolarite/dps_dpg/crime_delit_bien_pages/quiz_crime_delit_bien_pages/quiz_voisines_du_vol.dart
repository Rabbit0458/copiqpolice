...
class QuizVoisinesDuVol extends StatefulWidget {
  ...
  const QuizVoisinesDuVol({super.key, required this.uid, required this.email});

  @override
  State<QuizVoisinesDuVol> createState() => _QuizVoisinesDuVolState();
}

class _QuizVoisinesDuVolState extends State<QuizVoisinesDuVol>
