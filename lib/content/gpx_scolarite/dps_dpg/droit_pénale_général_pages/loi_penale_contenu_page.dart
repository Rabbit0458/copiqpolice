...
class LoiPenaleContenuPage extends StatelessWidget {
  const LoiPenaleContenuPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/droit_pénale_général_pages/loi_penale_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/droit_pénale_général_pages/loi_penale/etendue_application_lois',
            ),
          ),
          const SizedBox(height: 14),
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/gpx_scolarite_pages/droit_pénale_général_pages/loi_penale/generalites_legislation_penale',
            ),
          ),
          const SizedBox(height: 14),
