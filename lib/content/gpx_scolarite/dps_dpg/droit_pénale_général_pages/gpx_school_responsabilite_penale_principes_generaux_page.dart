...
class GPXSchoolResponsabilitePenalePrincipesGenerauxPage
    extends StatelessWidget {
  const GPXSchoolResponsabilitePenalePrincipesGenerauxPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ScolariteText.value(
            "lib/content/gpx_scolarite/dps_dpg/droit_pénale_général_pages/gpx_school_responsabilite_penale_principes_generaux_page.dart",
            "f00001",
