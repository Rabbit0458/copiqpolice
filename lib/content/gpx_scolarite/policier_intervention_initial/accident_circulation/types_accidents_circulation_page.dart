...
class TypesAccidentsCirculationPage extends StatelessWidget {
  const TypesAccidentsCirculationPage({super.key});

  static const String routeName =
      '/gpx/intervention/accident-circulation/types-accidents';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/policier_intervention_initial/accident_circulation/types_accidents_circulation_page.dart",
            "f00001",
            'Retour',
          ),
        ),
