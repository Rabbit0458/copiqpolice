...
class SecuriteTrajetLieuxPage extends StatelessWidget {
  const SecuriteTrajetLieuxPage({super.key});

  static const String routeName =
      '/gpx/intervention/accident-circulation/securite-trajet-lieux';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/policier_intervention_initial/accident_circulation/securite_trajet_lieux_page.dart",
            "f00001",
            'Retour',
          ),
        ),
