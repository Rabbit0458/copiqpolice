...
class PrimoSceneInfractionAmarisPage extends StatelessWidget {
  const PrimoSceneInfractionAmarisPage({super.key});

  static const String routeName =
      '/gpx/intervention/autres/primo-scene-infraction-amaris';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/policier_intervention_initial/autres/primo_scene_infraction_amaris_page.dart",
            "f00001",
            'Retour',
          ),
        ),
