...
class PlansOrsecPage extends StatelessWidget {
  const PlansOrsecPage({super.key});

  static const String routeName = '/gpx/intervention/autres/plans-orsec';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              _Paragraph.rich([
                const TextSpan(text: "Le cadre général est fixé par le "),
                TextSpan(
