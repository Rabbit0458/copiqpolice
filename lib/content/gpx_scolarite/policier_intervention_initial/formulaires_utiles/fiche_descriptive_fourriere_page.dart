...
class FicheDescriptiveFourrierePage extends StatelessWidget {
  const FicheDescriptiveFourrierePage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/policier_intervention_initial/formulaires_utiles/fiche_descriptive_fourriere_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              _ZoomableAsset(
                assetPath: 'assets/images/fourriere.png',
                heroTag: 'fiche_fourriere',
              ),
            ],
          ),
        ],
