...
class AvisRetentionPermisPage extends StatelessWidget {
  const AvisRetentionPermisPage({super.key});

  static const String routeName =
      '/gpx/intervention/formulaires-utiles/avis-retention-permis';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/gpx_scolarite/policier_intervention_initial/formulaires_utiles/avis_retention_permis_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              _ZoomableAsset(
                assetPath: 'assets/images/retention_pc_recto.png',
                heroTag: 'retention_permis_recto',
              ),
            ],
          ),
          ...
          _ConditionCard(
            ...
            children: const [
              _ZoomableAsset(
                assetPath: 'assets/images/retention_pc_verso.png',
                heroTag: 'retention_permis_verso',
              ),
            ],
          ),
        ],
    ...
    return GestureDetector(
      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          child: AspectRatio(
            // Permet un rendu stable (document)
            aspectRatio: 0.72,
