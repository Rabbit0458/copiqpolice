...
class PaEnqueteAdministrativePage extends StatelessWidget {
  const PaEnqueteAdministrativePage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/institution_valeurs/deontologie/enquete_administrative_page.dart",
            "f00001",
            'Retour',
          ),
        ),
