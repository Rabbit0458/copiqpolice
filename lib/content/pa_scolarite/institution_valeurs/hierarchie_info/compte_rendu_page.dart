...
class PaCompteRenduPage extends StatelessWidget {
  const PaCompteRenduPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/institution_valeurs/hierarchie_info/compte_rendu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
