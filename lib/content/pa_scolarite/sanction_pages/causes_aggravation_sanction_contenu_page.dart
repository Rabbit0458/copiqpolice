...
class PaCausesAggravationSanctionContenuPage extends StatelessWidget {
  const PaCausesAggravationSanctionContenuPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/sanctions/causes_aggravation_sanction';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/sanction_pages/causes_aggravation_sanction_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/pa/dps_dpg/sanctions/causes_aggravation_sanction/bande_organisee',
            ),
          ),
          const SizedBox(height: 14),
