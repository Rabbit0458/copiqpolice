...
class PaBandeOrganiseePage extends StatelessWidget {
  const PaBandeOrganiseePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/sanction_pages/causes_aggravation_sanction/bande_organisee_page.dart",
            "f00001",
            'La bande organisée',
          ),
