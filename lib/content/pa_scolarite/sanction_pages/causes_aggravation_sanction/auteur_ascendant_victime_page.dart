...
class PaAuteurAscendantVictimePage extends StatelessWidget {
  const PaAuteurAscendantVictimePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/sanction_pages/causes_aggravation_sanction/auteur_ascendant_victime_page.dart",
            "f00001",
