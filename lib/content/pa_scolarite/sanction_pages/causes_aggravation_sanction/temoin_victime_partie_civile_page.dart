...
class PaTemoinVictimePartieCivilePage extends StatelessWidget {
  const PaTemoinVictimePartieCivilePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/sanction_pages/causes_aggravation_sanction/temoin_victime_partie_civile_page.dart",
            "f00001",
