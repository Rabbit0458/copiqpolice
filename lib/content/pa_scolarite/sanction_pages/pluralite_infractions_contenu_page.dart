...
class PaPluraliteInfractionsContenuPage extends StatelessWidget {
  const PaPluraliteInfractionsContenuPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/sanctions/pluralite_infractions';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => _openRoute(
              context,
              '/pa/dps_dpg/sanctions/pluralite_infractions/recidive',
            ),
          ),
