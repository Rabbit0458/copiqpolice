...
import 'package:copiqpolice/content/gpx_scolarite/dps_dpg/generalite_pages/libert%C3%A9s_publiques/individuelles/droit_vie_privee_page.dart';
...
class PaLibertesIndividuellesViePriveePage extends StatelessWidget {
  const PaLibertesIndividuellesViePriveePage({super.key});

  static const String routeName =
      '/pa/dps_dpg/libertes_publiques/libertes_individuelles_vie_privee';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => Navigator.of(
              context,
            ).pushNamed(QuizLibertesPubliquesIndividuellesPageGPX.routeName),
          ),
          const SizedBox(height: 22),
        ],
      ),
