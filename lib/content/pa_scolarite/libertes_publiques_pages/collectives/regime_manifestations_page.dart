...
/// ===================================================================
class PaRegimeManifestationsPage extends StatelessWidget {
  const PaRegimeManifestationsPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/libertes_publiques/collectives/regime_manifestations';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/libertes_publiques_pages/collectives/regime_manifestations_page.dart",
            "f00001",
