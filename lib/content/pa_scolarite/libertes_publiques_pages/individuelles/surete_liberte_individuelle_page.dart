...
/// ===================================================================
class PaSureteLiberteIndividuellePage extends StatelessWidget {
  const PaSureteLiberteIndividuellePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/libertes_publiques_pages/individuelles/surete_liberte_individuelle_page.dart",
            "f00001",
