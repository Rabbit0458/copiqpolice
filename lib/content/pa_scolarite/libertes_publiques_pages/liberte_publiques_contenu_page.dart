...
/// =============================================================
class PaLibertesPubliquesContenuPage extends StatelessWidget {
  const PaLibertesPubliquesContenuPage({super.key});

  static const String routeName = '/pa/dps_dpg/libertes_publiques/contenu';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/libertes_publiques_pages/liberte_publiques_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
