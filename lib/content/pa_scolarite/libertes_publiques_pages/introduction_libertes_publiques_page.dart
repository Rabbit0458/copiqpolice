...
import 'package:copiqpolice/content/gpx_scolarite/dps_dpg/generalite_pages/libert%C3%A9s_publiques/introduction/declaration_droits_homme_page.dart';
import 'package:copiqpolice/content/gpx_scolarite/dps_dpg/generalite_pages/libert%C3%A9s_publiques/introduction/regime_juridique_libertes_publiques_page.dart';
...
import 'package:copiqpolice/content/gpx_scolarite/quiz_scolarite_gpx/gpx_quiz_libertes_publiques_page.dart';
...
/// =============================================================
class PaIntroductionLibertesPubliquesPage extends StatelessWidget {
  const PaIntroductionLibertesPubliquesPage({super.key});

  static const String routeName = '/pa/dps_dpg/libertes_publiques/introduction';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/libertes_publiques_pages/introduction_libertes_publiques_page.dart",
            "f00001",
            'Retour',
          ),
        ),
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => Navigator.of(
              context,
            ).pushNamed(QuizLibertesPubliquesPageGPX.routeName),
          ),
          const SizedBox(height: 22),
        ],
      ),
