...
class PaDgsiPage extends StatelessWidget {
  const PaDgsiPage({super.key});

  static const String routeName = '/pa/institution/organisation_pn/dgsi';

  // Rouge “articles / références / points clés” (comme ton template)
  ...
  Widget build(BuildContext context) {
    ...
    final Color cardMissions = isDark
        ? const Color(0xFF1D2A24)
        : const Color(0xFFF1FBF5);
    final Color cardDomaines = isDark
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/organisation_pn/pa_dgsi_page.dart",
            "f00001",
            'Retour',
          ),
        ),
