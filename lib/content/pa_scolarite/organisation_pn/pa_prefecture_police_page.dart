...
class PaPrefecturePolicePage extends StatelessWidget {
  const PaPrefecturePolicePage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/organisation_pn/pa_prefecture_police_page.dart",
            "f00001",
            'Retour',
          ),
        ),
