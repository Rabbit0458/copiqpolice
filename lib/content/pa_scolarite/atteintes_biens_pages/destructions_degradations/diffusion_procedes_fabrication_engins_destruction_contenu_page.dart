...
class PaDiffusionProcedesFabricationEnginsDestructionPage
    extends StatelessWidget {
  const PaDiffusionProcedesFabricationEnginsDestructionPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_biens_pages/destructions_degradations/diffusion_procedes_fabrication_engins_destruction_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
