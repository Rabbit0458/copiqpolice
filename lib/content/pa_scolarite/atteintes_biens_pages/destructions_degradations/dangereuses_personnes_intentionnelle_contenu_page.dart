...
class PaDestructionsDangereusesPersonnesIntentionnellePage
    extends StatelessWidget {
  const PaDestructionsDangereusesPersonnesIntentionnellePage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_biens_pages/destructions_degradations/dangereuses_personnes_intentionnelle_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
