...
class PaVolPage extends StatelessWidget {
  const PaVolPage({super.key});

  static const String routeName = '/pa/dps_dpg/atteintes_biens/vol';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_biens_pages/vol_page.dart",
            "f00001",
            'Retour',
          ),
        ),
