...
class PaAuditionEnquetePreliminaireGpxSchool extends StatelessWidget {
  const PaAuditionEnquetePreliminaireGpxSchool({super.key});

  static const String routeName =
      '/pa/dps_dpg/cadres_juridiques/enquete_preliminaire/actes/auditions';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/cadres_juridiques_pages/enquete_preliminaire/audition_enquete_preliminaire_gpx_school.dart",
            "f00001",
            'Les auditions',
          ),
        ),
