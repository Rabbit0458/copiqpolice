// lib/pa/dps_dpg/cadres_juridiques/mort_inconnue/mort_inconnue_actes_enquete.dart
...
class PaMortInconnueActesEnquetePage extends StatelessWidget {
  const PaMortInconnueActesEnquetePage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/cadres_juridiques_pages/mort_inconnue/mort_inconnue_actes_enquete.dart",
            "f00001",
            'Retour',
          ),
        ...
        children: [
          ...
          _Paragraph.rich([
            ...
            TextSpan(
              text: ScolariteText.value(
                "lib/content/pa_scolarite/cadres_juridiques_pages/mort_inconnue/mort_inconnue_actes_enquete.dart",
                "f00007",
                'l’article 74 alinéa 1 du Code de procédure pénale',
              ),
          ...
          _ConditionCard(
            title: ScolariteText.value(
              "lib/content/pa_scolarite/cadres_juridiques_pages/mort_inconnue/mort_inconnue_actes_enquete.dart",
              "f00010",
              '1. Transport sur les lieux et premières constatations',
            ),
            cardColor: cardColor,
            accent: accent,
            titleColor: textMain,
          ...
          _ConditionCard(
            title: ScolariteText.value(
              "lib/content/pa_scolarite/cadres_juridiques_pages/mort_inconnue/mort_inconnue_actes_enquete.dart",
              "f00025",
              '2. Heures légales et nécessité de porter secours',
            ),
            cardColor: cardColor,
            accent: accent,
            titleColor: textMain,
          ...
          _ConditionCard(
            title: ScolariteText.value(
              "lib/content/pa_scolarite/cadres_juridiques_pages/mort_inconnue/mort_inconnue_actes_enquete.dart",
              "f00036",
              '3. Détermination du cadre juridique d’enquête',
            ),
            cardColor: cardColor,
            accent: accent,
            titleColor: textMain,
