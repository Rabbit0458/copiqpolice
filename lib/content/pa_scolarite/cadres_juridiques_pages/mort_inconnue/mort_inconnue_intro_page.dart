...
class PaMortInconnueIntroPage extends StatelessWidget {
  const PaMortInconnueIntroPage({super.key});

  static const String routeName = '/pa/dps_dpg/cadres_juridiques/mort_inconnue/intro';
      ...
      body: ListView(
        ...
        children: [
          ...
          const _Paragraph.rich([
            ...
            TextSpan(text: ' (recherche des causes de la mort) et '),
            TextSpan(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _Paragraph.rich([
                TextSpan(text: 'La procédure dite de '),
                TextSpan(
                  text: '« recherche des causes de la mort »',
                  style: TextStyle(fontWeight: FontWeight.w700),
                ),
                TextSpan(text: ' est prévue par '),
                TextSpan(
                  text: 'l’article 74 du Code de procédure pénale',
                  style: TextStyle(
                    color: lawColor,
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle('De la mort inexpliquée à l’enquête pénale'),
              _Paragraph.rich([
                TextSpan(
                  text:
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle('Points clés à connaître par cœur'),
              _Paragraph.rich([
                TextSpan(text: '• '),
                TextSpan(
                  text: 'L’article 74 du Code de procédure pénale',
