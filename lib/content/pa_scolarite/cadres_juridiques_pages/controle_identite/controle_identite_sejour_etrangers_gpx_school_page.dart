...
class PaConntroleIdentiteSejourGpxSchool extends StatelessWidget {
  const PaConntroleIdentiteSejourGpxSchool({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/cadres_juridiques_pages/controle_identite/controle_identite_sejour_etrangers_gpx_school_page.dart",
            "f00001",
            'Retour',
          ),
        ),
