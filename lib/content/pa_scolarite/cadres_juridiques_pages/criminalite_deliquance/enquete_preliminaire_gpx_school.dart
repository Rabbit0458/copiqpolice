...
class PaEnquetePreliminaireGpxSchool extends StatelessWidget {
  const PaEnquetePreliminaireGpxSchool({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/cadres_juridiques_pages/criminalite_deliquance/enquete_preliminaire_gpx_school.dart",
            "f00001",
