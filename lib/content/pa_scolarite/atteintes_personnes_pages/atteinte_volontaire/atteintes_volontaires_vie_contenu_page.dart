...
class PaAtteintesVolontairesVieContenuPage extends StatelessWidget {
  const PaAtteintesVolontairesVieContenuPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/atteintes_personnes/atteintes_volontaires_vie';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_personnes_pages/atteinte_volontaire/atteintes_volontaires_vie_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
