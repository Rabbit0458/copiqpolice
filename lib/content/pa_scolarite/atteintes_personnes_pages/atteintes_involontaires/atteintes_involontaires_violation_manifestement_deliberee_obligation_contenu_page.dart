...
class PaAtteintesInvolontairesViolationManifestementDelibereeObligationPage
    extends StatelessWidget {
  const PaAtteintesInvolontairesViolationManifestementDelibereeObligationPage({
    super.key,
  });
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_personnes_pages/atteintes_involontaires/atteintes_involontaires_violation_manifestement_deliberee_obligation_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
