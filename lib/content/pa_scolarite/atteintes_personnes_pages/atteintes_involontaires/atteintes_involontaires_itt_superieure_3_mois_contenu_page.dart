...
class PaAtteintesInvolontairesIttSuperieure3MoisPage extends StatelessWidget {
  const PaAtteintesInvolontairesIttSuperieure3MoisPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              _Paragraph.rich([
                TextSpan(text: "Texte d’incrimination : "),
                TextSpan(
              ...
              SizedBox(height: 8),
              _Paragraph.rich([
                TextSpan(text: "Renvoi essentiel : "),
                TextSpan(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _SubTitle("1) Causalité indirecte"),
              _Paragraph.rich([
                TextSpan(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              SizedBox(height: 10),
              _SubTitle("Exception : violation manifestement délibérée"),
              _Paragraph(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _BulletPoint(text: "Excès de vitesse ≥ 50 km/h."),
              _BulletPoint(text: "Délit de fuite."),
              SizedBox(height: 10),
              ...
              _BulletPoint(text: "Absence de permis de détention."),
              _BulletPoint(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              _Paragraph.rich([
                TextSpan(text: "Aggravée (conducteur — 1er degré) : "),
                TextSpan(
                  text: "3 ans d’emprisonnement et 45 000 € d’amende — ",
                ),
                TextSpan(
              ...
              SizedBox(height: 8),
              _Paragraph.rich([
                TextSpan(text: "Aggravée (conducteur — 2e degré) : "),
                TextSpan(
              ...
              SizedBox(height: 8),
              _Paragraph.rich([
                TextSpan(text: "Aggravée (conducteur — 3e degré) : "),
                TextSpan(
              ...
              SizedBox(height: 8),
              _Paragraph.rich([
                TextSpan(text: "Aggravée (chien — 1er degré) : "),
                TextSpan(
                  text: "3 ans d’emprisonnement et 45 000 € d’amende — ",
                ),
                TextSpan(
              ...
              SizedBox(height: 8),
              _Paragraph.rich([
                TextSpan(text: "Aggravée (chien — 2e degré) : "),
                TextSpan(
                  text: "5 ans d’emprisonnement et 75 000 € d’amende — ",
                ),
                TextSpan(
              ...
              SizedBox(height: 8),
              _Paragraph.rich([
                TextSpan(text: "Aggravée (chien — 3e degré) : "),
                TextSpan(
                  text: "7 ans d’emprisonnement et 100 000 € d’amende — ",
                ),
                TextSpan(
              ...
              _Paragraph.rich([
                ...
                TextSpan(text: "doublement des peines — "),
                TextSpan(
                  text: "article 434-10 du Code pénal",
                  style: TextStyle(
                    color: _lawRed,
