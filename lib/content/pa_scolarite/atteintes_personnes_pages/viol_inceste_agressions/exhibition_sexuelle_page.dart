...
class PaExhibitionSexuellePage extends StatelessWidget {
  const PaExhibitionSexuellePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_personnes_pages/viol_inceste_agressions/exhibition_sexuelle_page.dart",
            "f00001",
            "Exhibition sexuelle",
          ),
