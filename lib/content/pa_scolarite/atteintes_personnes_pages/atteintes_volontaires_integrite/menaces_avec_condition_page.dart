...
class PaMenacesAvecConditionPage extends StatelessWidget {
  const PaMenacesAvecConditionPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_personnes_pages/atteintes_volontaires_integrite/menaces_avec_condition_page.dart",
            "f00001",
            'Retour',
          ),
        ),
            ...
            children: [
              ...
              _SubTitle(
                ScolariteText.value(
                  "lib/content/pa_scolarite/atteintes_personnes_pages/atteintes_volontaires_integrite/menaces_avec_condition_page.dart",
                  "f00030",
                  "D) Ordre de remplir une condition",
                ),
              ),
              _Paragraph(
                ScolariteText.value(
              ...
              _Paragraph.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/pa_scolarite/atteintes_personnes_pages/atteintes_volontaires_integrite/menaces_avec_condition_page.dart",
                    "f00046",
                    "Article 222-18 alinéa 2 du Code pénal",
                  ),
                  style: TextStyle(color: _lawRed, fontWeight: FontWeight.w900),
                ),
                TextSpan(text: " :"),
              ...
              _Paragraph.rich([
                ...
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/pa_scolarite/atteintes_personnes_pages/atteintes_volontaires_integrite/menaces_avec_condition_page.dart",
                    "f00056",
                    "article 222-18 alinéa 1 du Code pénal",
                  ),
                  style: TextStyle(color: _lawRed, fontWeight: FontWeight.w900),
                ),
                const TextSpan(text: "."),
              ...
              _Paragraph.rich([
                TextSpan(
                  text: ScolariteText.value(
                    "lib/content/pa_scolarite/atteintes_personnes_pages/atteintes_volontaires_integrite/menaces_avec_condition_page.dart",
                    "f00060",
                    "Aggravations (conjoint/concubin/PACS) : ",
                  ),
                  style: TextStyle(
                    fontWeight: FontWeight.w900,
                    color: textMain,
