...
class PaProxenetismeAssimilationPage extends StatelessWidget {
  const PaProxenetismeAssimilationPage({super.key});
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _SubTitle("A) 1° — Faire office d’intermédiaire"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("Exemples jurisprudentiels"),
              _NotaBox(
                bodySpans: [
                  TextSpan(
                    text:
              ...
              SizedBox(height: 10),
              _SubTitle("1) Cohabitation ou relations habituelles"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("2) Impossibilité de justifier son train de vie"),
              _Paragraph(
