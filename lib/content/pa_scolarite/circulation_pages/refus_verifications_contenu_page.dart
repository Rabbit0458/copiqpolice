...
class PaRefusVerificationsPage extends StatelessWidget {
  const PaRefusVerificationsPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/socle_initial/circulation/refus_verifications';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/circulation_pages/refus_verifications_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
