...
class PaGrandExcesVitessePage extends StatelessWidget {
  const PaGrandExcesVitessePage({super.key});

  static const String routeName =
      '/pa/dps_dpg/socle_initial/circulation/grand_exces_vitesse';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/circulation_pages/grand_exces_vitesse_page.dart",
            "f00001",
            'Retour',
          ),
        ),
