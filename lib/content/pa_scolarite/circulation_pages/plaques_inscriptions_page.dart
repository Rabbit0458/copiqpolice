...
class PaPlaquesInscriptionsPage extends StatelessWidget {
  const PaPlaquesInscriptionsPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/socle_initial/circulation/plaques_inscriptions';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/circulation_pages/plaques_inscriptions_page.dart",
            "f00001",
            'Retour',
          ),
        ),
