...
// PAGE
// ============================================================================
class QuizSanctionAggravationPA extends StatefulWidget {
  ...
  const QuizSanctionAggravationPA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizSanctionAggravationPA> createState() =>
      _QuizSanctionAggravationPAState();
}

class _QuizSanctionAggravationPAState extends State<QuizSanctionAggravationPA>
  ...
  static const _introHiddenKey = 'intro_pa_sanction_aggravation';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_sanction_aggravation',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_sanction_aggravation',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Aggravation des sanctions',
                                description:
                                    'Identifie les circonstances aggravantes générales et spéciales, leur impact sur les peines et leur application en pratique.',
