...
class QuizAtteinteVolontairePA extends StatefulWidget {
  ...
  @override
  State<QuizAtteinteVolontairePA> createState() =>
      _QuizAtteinteVolontairePAState();
}
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_atteintes_volontaires',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise les crimes et délits volontaires contre les personnes : meurtre, assassinat, violences et leurs circonstances aggravantes.',
