...
final List<QuizQuestion> questionsCriminaliteOrganisee = [
  ...
  const QuizQuestion(
    ...
    question: "La bande organisée est définie par le Code pénal comme :",
    options: [
  ...
  const QuizQuestion(
    category: "Bande organisée",
    question: "En matière de criminalité organisée, la 'filière' désigne :",
    options: [
  ...
  const QuizQuestion(
    ...
    question: "L'association de malfaiteurs (art. 450-1 Cp) est punissable :",
    options: [
  ...
  const QuizQuestion(
    category: "Techniques spéciales d'enquête",
    question: "La livraison surveillée (art. 706-80 CPP) peut porter sur :",
    options: [
  ...
  const QuizQuestion(
    ...
    answer: "Sur autorisation du juge des libertés et de la détention (JLD)",
    explanation:
  ...
  const QuizQuestion(
    ...
    question: "Le report de procédure permet à l'OPJ de :",
    options: [
  ...
  const QuizQuestion(
    ...
    question: "La saisie pénale spéciale (art. 706-141 CPP) vise à :",
    options: [
  ...
  const QuizQuestion(
    ...
    question: "Le blanchiment commis en bande organisée est puni de :",
    options: [
  ...
  const QuizQuestion(
    ...
    question: "Le gel des avoirs en matière de criminalité organisée permet :",
    options: [
...
// PAGE
// ============================================================================
class QuizCriminaliteOrganiseePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/criminalite_organisee';
  final String uid;
  final String email;

  const QuizCriminaliteOrganiseePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCriminaliteOrganiseePagePA> createState() =>
      _QuizCriminaliteOrganiseePagePAState();
}

class _QuizCriminaliteOrganiseePagePAState
    extends State<QuizCriminaliteOrganiseePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_criminalite_organisee';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_criminalite_organisee',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_criminalite_organisee',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Découvre le régime juridique de la criminalité organisée : bandes organisées, trafics, éléments constitutifs et procédures d’exception.',
