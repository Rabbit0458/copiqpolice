...
// PAGE
// ============================================================================
class QuizClassificationInfractionsPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/generalites/quiz/classification_infractions';
  final String uid;
  final String email;

  const QuizClassificationInfractionsPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizClassificationInfractionsPagePA> createState() =>
      _QuizClassificationInfractionsPagePAState();
}

class _QuizClassificationInfractionsPagePAState
    extends State<QuizClassificationInfractionsPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_classification_infractions';
  String?
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_classification_infractions_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_classification_infractions_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Distingue crimes, délits et contraventions. Maîtrise les critères de classification et leurs conséquences juridiques et procédurales.',
