...
// PAGE
// ============================================================================
class QuizLegitimeDefensePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/legitimedefense';
  final String uid;
  final String email;

  const QuizLegitimeDefensePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizLegitimeDefensePagePA> createState() =>
      _QuizLegitimeDefensePagePAState();
}

class _QuizLegitimeDefensePagePAState extends State<QuizLegitimeDefensePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_legitime_defense';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_legitime_defense_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_legitime_defense_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise les conditions de la légitime défense : nécessité, proportionnalité, actualité du danger et présomptions légales associées.',
