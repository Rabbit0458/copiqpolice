...
class QuizLegitimeDefensePagePA extends StatefulWidget {
  ...
  @override
  State<QuizLegitimeDefensePagePA> createState() => _QuizLegitimeDefensePagePAState();
}
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            description: 'Maîtrise les conditions de la légitime défense : nécessité, proportionnalité, actualité du danger et présomptions légales associées.',
