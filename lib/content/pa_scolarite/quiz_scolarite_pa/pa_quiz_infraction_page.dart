  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_infraction_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Infractions',
                                description:
                                    'Maîtrise les éléments constitutifs d’une infraction : légal, matériel, moral. Tentative, complicité et causes d’irresponsabilité.',
