...
// ============================================================================
class QuizInfractionsPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/infractions/quiz/infractions';

  final String uid;
  final String email;

  const QuizInfractionsPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizInfractionsPagePA> createState() => _QuizInfractionsPagePAState();
}

class _QuizInfractionsPagePAState extends State<QuizInfractionsPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_infraction';
  String?
    ...
    try {
      ...
      final res = await _sb
          ...
          .insert({
            ...
            'mode': UserContextService.I.modeOrDefault,'module_name': 'Infractions',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_infraction_page',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            title: 'Infractions',
                            description: 'Maîtrise les éléments constitutifs d’une infraction : légal, matériel, moral. Tentative, complicité et causes d’irresponsabilité.',
