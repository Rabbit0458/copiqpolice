  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_viol_inceste_agressions',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Approfondis les infractions sexuelles : viol, agression sexuelle, inceste, circonstances aggravantes et procédures adaptées.',
