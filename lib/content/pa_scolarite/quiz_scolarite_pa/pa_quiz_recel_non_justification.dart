...
// PAGE
// ============================================================================
class QuizRecelNonJustificationPA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/crimes_biens/quiz/recel_non_justification';
  final String uid;
  final String email;

  const QuizRecelNonJustificationPA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizRecelNonJustificationPA> createState() =>
      _QuizRecelNonJustificationPAState();
}

class _QuizRecelNonJustificationPAState
    extends State<QuizRecelNonJustificationPA>
  ...
  static const _introHiddenKey = 'intro_pa_recel_non_justification';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_recel_non_justification',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_recel_non_justification',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise le recel : éléments constitutifs, liens avec l’infraction d’origine et infraction de non-justification de ressources.',
