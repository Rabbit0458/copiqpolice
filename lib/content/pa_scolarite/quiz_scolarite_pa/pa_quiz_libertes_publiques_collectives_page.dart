...
// PAGE
// ============================================================================
class QuizLibertesPubliquesCollectivesPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/generalites/quiz/libertes_publiques_collectives';

  final String uid;
  final String email;

  const QuizLibertesPubliquesCollectivesPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizLibertesPubliquesCollectivesPagePA> createState() =>
      _QuizLibertesPubliquesCollectivesPagePAState();
}

class _QuizLibertesPubliquesCollectivesPagePAState
    extends State<QuizLibertesPubliquesCollectivesPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_libertes_publiques_collectives';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_libertes_publiques_collectives_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_libertes_publiques_collectives_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Libertés collectives',
                                description:
                                    'Explore les libertés collectives : droit de réunion, liberté de manifestation, liberté syndicale et leurs limites légales.',
