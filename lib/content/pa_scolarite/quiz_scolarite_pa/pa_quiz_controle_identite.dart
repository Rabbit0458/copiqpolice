...
// PAGE
// ============================================================================
class QuizControleIdentitePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/controle_identite';
  final String uid;
  final String email;

  const QuizControleIdentitePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizControleIdentitePagePA> createState() =>
      _QuizControleIdentitePagePAState();
}

class _QuizControleIdentitePagePAState extends State<QuizControleIdentitePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_controle_identite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_controle_identite',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_controle_identite',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise les différents types de contrôle d’identité : judiciaire, administratif, préventif. Conditions, procédures et droits des personnes.',
