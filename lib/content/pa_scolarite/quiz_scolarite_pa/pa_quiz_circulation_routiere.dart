...
// PAGE
// ============================================================================
class QuizCirculationRoutierePA extends StatefulWidget {
  ...
  const QuizCirculationRoutierePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCirculationRoutierePA> createState() => _QuizCirculationRoutierePAState();
}

class _QuizCirculationRoutierePAState extends State<QuizCirculationRoutierePA>
  ...
  static const _introHiddenKey = 'intro_pa_circulation_routiere';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_circulation_routiere',
