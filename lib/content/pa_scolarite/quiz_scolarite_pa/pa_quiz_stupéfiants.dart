...
// PAGE
// ============================================================================
class QuizStupefiantPA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/stupéfiants_pages/quiz/pa_quiz_stupéfiants';
  final String uid;
  final String email;

  const QuizStupefiantPA({super.key, required this.uid, required this.email});

  @override
  State<QuizStupefiantPA> createState() => _QuizStupefiantPAState();
}

class _QuizStupefiantPAState extends State<QuizStupefiantPA>
  ...
  static const _introHiddenKey = 'intro_pa_stupefiants';
    ...
    try {
      final res = await _sb
          ...
          .insert({
            ...
            'mode': UserContextService.I.modeOrDefault,'module_name': 'Stupéfiants — usage & trafic',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_stupéfiants',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            title: 'Stupéfiants',
                            description: 'Étudie la législation sur les stupéfiants : usage, trafic, offre, associations de malfaiteurs et procédures d’enquête spécifiques.',
