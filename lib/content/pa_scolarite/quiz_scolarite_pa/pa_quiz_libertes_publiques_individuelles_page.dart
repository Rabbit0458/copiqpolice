...
// PAGE
// ============================================================================
class QuizLibertesPubliquesIndividuellesPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/generalites/quiz/libertes_publiques_individuelles';

  final String uid;
  final String email;

  const QuizLibertesPubliquesIndividuellesPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizLibertesPubliquesIndividuellesPagePA> createState() =>
      _QuizLibertesPubliquesIndividuellesPagePAState();
}

class _QuizLibertesPubliquesIndividuellesPagePAState
    extends State<QuizLibertesPubliquesIndividuellesPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_libertes_publiques_individuelles';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_libertes_publiques_individuelles_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_libertes_publiques_individuelles_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Libertés individuelles',
                                description:
                                    'Approfondis les libertés individuelles fondamentales : liberté d’aller et venir, sûreté personnelle, vie privée et leur protection juridique.',
