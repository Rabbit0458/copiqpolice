...
class QuizResponsabilitePenalePagePA extends StatefulWidget {
  ...
  @override
  State<QuizResponsabilitePenalePagePA> createState() =>
      _QuizResponsabilitePenalePagePAState();
}

class _QuizResponsabilitePenalePagePAState
    extends State<QuizResponsabilitePenalePagePA>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_responsabilite_penal_general',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends les fondements de la responsabilité pénale : imputabilité, causes d’irresponsabilité, responsabilité des personnes morales.',
