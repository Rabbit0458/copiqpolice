...
// PAGE
// ============================================================================
class QuizInstructionPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/procedure_penale/quiz/instruction_preparatoire';
  final String uid;
  final String email;

  const QuizInstructionPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizInstructionPagePA> createState() => _QuizInstructionPagePAState();
}

class _QuizInstructionPagePAState extends State<QuizInstructionPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_instruction';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_instruction_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_instruction_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Approfondis la phase d’instruction : rôle du juge d’instruction, actes possibles, droits des parties et clôture.',
