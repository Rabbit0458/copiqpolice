...
// PAGE
// ============================================================================
class QuizGarantiesLibertesPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/generalites/quiz/garanties_libertes_publiques';

  final String uid;
  final String email;

  const QuizGarantiesLibertesPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizGarantiesLibertesPagePA> createState() =>
      _QuizGarantiesLibertesPagePAState();
}

class _QuizGarantiesLibertesPagePAState
    extends State<QuizGarantiesLibertesPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_libertes_publiques_garanties';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_libertes_publiques_garanties_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_libertes_publiques_garanties_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends les mécanismes de garantie des libertés publiques : rôle du juge, contrôle de constitutionnalité et recours disponibles.',
