...
// PAGE
// ============================================================================
class QuizJuridictionsPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/procedure_penale/quiz/juridictions_penales';
  final String uid;
  final String email;

  const QuizJuridictionsPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizJuridictionsPagePA> createState() => _QuizJuridictionsPagePAState();
}

class _QuizJuridictionsPagePAState extends State<QuizJuridictionsPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_juridiction';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_juridiction_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_juridiction_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Juridictions',
                                description:
                                    'Identifie les différentes juridictions françaises : tribunal correctionnel, cour d’assises, juridictions de proximité et leur compétence.',
