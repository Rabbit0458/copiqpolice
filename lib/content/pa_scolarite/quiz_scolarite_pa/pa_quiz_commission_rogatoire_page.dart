...
// PAGE
// ============================================================================
class QuizCommissionRogatoirePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/commission_rogatoire';
  final String uid;
  final String email;

  const QuizCommissionRogatoirePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCommissionRogatoirePagePA> createState() =>
      _QuizCommissionRogatoirePagePAState();
}

class _QuizCommissionRogatoirePagePAState
    extends State<QuizCommissionRogatoirePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_commission_rogatoire';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_commission_rogatoire_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_commission_rogatoire_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends la commission rogatoire : définition, acteurs, pouvoirs délégués au policier, conditions de validité et limites.',
