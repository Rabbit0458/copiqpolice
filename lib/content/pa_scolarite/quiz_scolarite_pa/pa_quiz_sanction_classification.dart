...
// PAGE
// ============================================================================
class QuizSanctionClassificationPA extends StatefulWidget {
  ...
  const QuizSanctionClassificationPA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizSanctionClassificationPA> createState() =>
      _QuizSanctionClassificationPAState();
}

class _QuizSanctionClassificationPAState
    extends State<QuizSanctionClassificationPA>
  ...
  static const _introHiddenKey = 'intro_pa_sanction_classification';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_sanction_classification',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_sanction_classification',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Distingue les catégories de peines : emprisonnement, amende, travaux d’intérêt général et sursis avec leur régime juridique.',
