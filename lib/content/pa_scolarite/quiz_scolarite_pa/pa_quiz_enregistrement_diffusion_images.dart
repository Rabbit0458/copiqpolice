...
// PAGE
// ============================================================================
class QuizEnregistrementDiffusionImagesPA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/crimes_personne/quiz/enregistrement_diffusion_images';
  final String uid;
  final String email;

  const QuizEnregistrementDiffusionImagesPA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizEnregistrementDiffusionImagesPA> createState() =>
      _QuizEnregistrementDiffusionImagesPAState();
}

class _QuizEnregistrementDiffusionImagesPAState
    extends State<QuizEnregistrementDiffusionImagesPA>
  ...
  static const _introHiddenKey = 'intro_pa_enregistrement_diffusion_images';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_enregistrement_diffusion_images',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_enregistrement_diffusion_images',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends la réglementation sur l’enregistrement et la diffusion d’images de personnes : droits à l’image et infractions.',
