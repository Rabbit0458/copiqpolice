...
// PAGE
// ============================================================================
class QuizBraceletElectroniquePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/procedure_penale/quiz/bracelet_electronique';
  final String uid;
  final String email;

  const QuizBraceletElectroniquePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizBraceletElectroniquePagePA> createState() =>
      _QuizBraceletElectroniquePagePAState();
}

class _QuizBraceletElectroniquePagePAState
    extends State<QuizBraceletElectroniquePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_bracelet_electronique';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_bracelet_electronique',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_bracelet_electronique',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Approfondis le placement sous surveillance électronique : conditions, suivi, violations et rôle des forces de l’ordre.',
