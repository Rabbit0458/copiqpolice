...
// PAGE
// ============================================================================
class QuizDisparitionPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/generalites/quiz/disparitions_inquietantes';
  final String uid;
  final String email;

  const QuizDisparitionPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizDisparitionPagePA> createState() => _QuizDisparitionPagePAState();
}

class _QuizDisparitionPagePAState extends State<QuizDisparitionPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_disparitions_inquietantes';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_disparitions_inquietantes',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_disparitions_inquietantes',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends les procédures liées aux disparitions inquiétantes : déclenchement des recherches, rôle des services et suites judiciaires.',
