...
// PAGE
// ============================================================================
class QuizGeneralitePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/procedure_penale/quiz/generalité_principales';
  final String uid;
  final String email;

  const QuizGeneralitePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizGeneralitePagePA> createState() => _QuizGeneralitePagePAState();
}

class _QuizGeneralitePagePAState extends State<QuizGeneralitePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_generalite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_generalite_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_generalite_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Généralités',
                                description:
                                    'Découvre les bases du droit et de la procédure pénale : principes fondamentaux, sources du droit, organisations judiciaires et notions clés.',
