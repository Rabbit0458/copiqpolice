...
// PAGE
// ============================================================================
class QuizPersonnesFuitePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/personnes_fuite';
  final String uid;
  final String email;

  const QuizPersonnesFuitePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizPersonnesFuitePagePA> createState() =>
      _QuizPersonnesFuitePagePAState();
}

class _QuizPersonnesFuitePagePAState extends State<QuizPersonnesFuitePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_personnes_fuite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_personnes_fuite',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_personnes_fuite',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Personnes en fuite',
                                description:
                                    'Maîtrise les procédures de recherche des personnes en fuite : diffusion, mandat d’arrêt européen et coopération policière.',
