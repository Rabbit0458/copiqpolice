...
// PAGE
// ============================================================================
class QuizAtteintePersonnalitePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/crimes_personne/quiz/atteinte_personnalite';
  final String uid;
  final String email;

  const QuizAtteintePersonnalitePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteintePersonnalitePA> createState() =>
      _QuizAtteintePersonnalitePAState();
}

class _QuizAtteintePersonnalitePAState extends State<QuizAtteintePersonnalitePA>
  ...
  static const _introHiddenKey = 'intro_pa_atteinte_personnalite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_atteinte_personnalite',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_atteinte_personnalite',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Atteinte à la personnalité',
                                description:
                                    'Étudie les infractions portant atteinte à la personnalité : diffamation, dénonciation calomnieuse, atteinte à la vie privée et à la réputation.',
