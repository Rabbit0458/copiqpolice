...
// PAGE
// ============================================================================
class QuizEnquetePreliminairePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/enquete_preliminaire';
  final String uid;
  final String email;

  const QuizEnquetePreliminairePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizEnquetePreliminairePagePA> createState() =>
      _QuizEnquetePreliminairePagePAState();
}

class _QuizEnquetePreliminairePagePAState
    extends State<QuizEnquetePreliminairePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_enquete_preliminaire';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_enquete_preliminaire_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_enquete_preliminaire_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise le cadre de l’enquête préliminaire : pouvoirs des enquêteurs, droits des personnes et actes autorisés.',
