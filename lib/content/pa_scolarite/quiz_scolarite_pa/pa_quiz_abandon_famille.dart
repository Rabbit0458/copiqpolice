  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_abandon_famille',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Teste tes connaissances sur l’abandon de famille, les obligations alimentaires et la protection des membres vulnérables du foyer.',
