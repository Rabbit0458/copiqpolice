...
// PAGE
// ============================================================================
class QuizSanctionPluralitePA extends StatefulWidget {
  ...
  @override
  State<QuizSanctionPluralitePA> createState() =>
      _QuizSanctionPluralitePAState();
}

class _QuizSanctionPluralitePAState extends State<QuizSanctionPluralitePA>
  ...
  static const _introHiddenKey = 'intro_pa_sanction_pluralite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_sanction_pluralite',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_sanction_pluralite',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Pluralité des sanctions',
                                description:
                                    'Comprends les règles de cumul des peines : concours d’infractions, récidive, confusion et non-cumul.',
