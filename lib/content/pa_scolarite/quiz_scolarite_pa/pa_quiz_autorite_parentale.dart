...
class QuizAutoriteParentalePA extends StatefulWidget {
  ...
  @override
  State<QuizAutoriteParentalePA> createState() =>
      _QuizAutoriteParentalePAState();
}

class _QuizAutoriteParentalePAState extends State<QuizAutoriteParentalePA>
  ...
  static const _introHiddenKey = 'intro_pa_autorite_parentale';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_autorite_parentale',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_autorite_parentale',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends le cadre juridique de l’autorité parentale : droits et devoirs des parents, conflits et rôle de la protection judiciaire.',
