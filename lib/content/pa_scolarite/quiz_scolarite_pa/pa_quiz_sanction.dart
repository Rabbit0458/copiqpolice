...
// PAGE
// ============================================================================
class QuizSanctionPA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/sanction/quiz/sanction_page';
  final String uid;
  final String email;

  const QuizSanctionPA({super.key, required this.uid, required this.email});

  @override
  State<QuizSanctionPA> createState() => _QuizSanctionPAState();
}

class _QuizSanctionPAState extends State<QuizSanctionPA>
  ...
  static const _introHiddenKey = 'intro_pa_sanction';
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Sanctions',
                                description:
                                    'Maîtrise les différentes sanctions pénales : peines principales, complémentaires, alternatives et le régime d’application des peines.',
