...
// PAGE
// ============================================================================
class QuizStadPA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/crimes_biens/quiz/stad';
  final String uid;
  final String email;

  const QuizStadPA({super.key, required this.uid, required this.email});

  @override
  State<QuizStadPA> createState() => _QuizStadPAState();
}

class _QuizStadPAState extends State<QuizStadPA> with TickerProviderStateMixin {
  // Page & data
  ...
  static const _introHiddenKey = 'intro_pa_stad';
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'STAD',
                                description:
                                    'Maîtrise les infractions relatives aux Systèmes de Traitement Automatisé de Données : accès frauduleux, entrave et atteintes aux systèmes.',
