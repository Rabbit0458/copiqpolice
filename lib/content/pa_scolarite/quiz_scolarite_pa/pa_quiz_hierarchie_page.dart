...
// PAGE
// ============================================================================
class QuizHierarchiePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/hierarchie';
  final String uid;
  final String email;

  const QuizHierarchiePagePA({super.key, required this.uid, required this.email});

  @override
  State<QuizHierarchiePagePA> createState() => _QuizHierarchiePagePAState();
}

class _QuizHierarchiePagePAState extends State<QuizHierarchiePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_hierarchie';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_hierarchie_page',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            title: 'Hiérarchie',
                            description: 'Comprends l’organisation hiérarchique de la police nationale : grades, commandement et relations entre services.',
