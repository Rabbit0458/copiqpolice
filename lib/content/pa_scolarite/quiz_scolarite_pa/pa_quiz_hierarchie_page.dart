  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_hierarchie_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Hiérarchie',
                                description:
                                    'Comprends l’organisation hiérarchique de la police nationale : grades, commandement et relations entre services.',
