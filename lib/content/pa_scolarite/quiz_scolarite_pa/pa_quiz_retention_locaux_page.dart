...
class QuizRetentionLocauxPagePA extends StatefulWidget {
  ...
  @override
  State<QuizRetentionLocauxPagePA> createState() =>
      _QuizRetentionLocauxPagePAState();
}
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_retention_locaux_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Approfondis la rétention administrative en locaux : conditions, durée, droits des personnes retenues et rôle du policier.',
