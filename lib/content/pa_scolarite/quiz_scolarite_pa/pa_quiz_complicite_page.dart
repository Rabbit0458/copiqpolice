...
// ============================================================================
class QuizComplicitePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/complicite/quiz/complicite';

  final String uid;
  final String email;

  const QuizComplicitePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizComplicitePagePA> createState() => _QuizComplicitePagePAState();
}

class _QuizComplicitePagePAState extends State<QuizComplicitePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_complicite';
  String?
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_complicite_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_complicite_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Complicité',
                                description:
                                    'Maîtrise la notion de complicité en droit pénal : modes de participation, conditions par aide et instigation, et sanctions applicables.',
