...
// PAGE
// ============================================================================
class QuizMandatsPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/procedure_penale/quiz/mandats_justice';
  final String uid;
  final String email;

  const QuizMandatsPagePA({super.key, required this.uid, required this.email});

  @override
  State<QuizMandatsPagePA> createState() => _QuizMandatsPagePAState();
}

class _QuizMandatsPagePAState extends State<QuizMandatsPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_mandats_justice';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_mandats_justice',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_mandats_justice',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Mandats de justice',
                                description:
                                    'Maîtrise les différents mandats de justice : comparution, d’amener, d’arrêt, de dépôt, leurs conditions et leur exécution.',
