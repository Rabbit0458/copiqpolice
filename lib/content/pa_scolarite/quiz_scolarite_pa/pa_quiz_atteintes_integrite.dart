...
// PAGE
// ============================================================================
class QuizAtteinteIntegritePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/crimes_personne/quiz/atteintes_volontaires_integrite';
  final String uid;
  final String email;

  const QuizAtteinteIntegritePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteIntegritePA> createState() =>
      _QuizAtteinteIntegritePAState();
}

class _QuizAtteinteIntegritePAState extends State<QuizAtteinteIntegritePA>
  ...
  static const _introHiddenKey = 'intro_pa_atteintes_integrite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_atteintes_integrite',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_atteintes_integrite',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Atteintes à l’intégrité',
                                description:
                                    'Évalue tes connaissances sur les violences volontaires et involontaires : coups, blessures, ITT et circonstances aggravantes.',
