...
class QuizAtteinteInvolontairePA extends StatefulWidget {
  ...
  @override
  State<QuizAtteinteInvolontairePA> createState() => _QuizAtteinteInvolontairePAState();
}
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            description: 'Distingue les homicides et blessures involontaires de leurs équivalents volontaires et identifie les éléments constitutifs de chaque infraction.',
