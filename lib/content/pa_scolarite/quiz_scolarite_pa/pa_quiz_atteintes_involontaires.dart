...
// PAGE
// ============================================================================
class QuizAtteinteInvolontairePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/crimes_personne/quiz/atteintes_involontaires';
  final String uid;
  final String email;

  const QuizAtteinteInvolontairePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteInvolontairePA> createState() =>
      _QuizAtteinteInvolontairePAState();
}

class _QuizAtteinteInvolontairePAState extends State<QuizAtteinteInvolontairePA>
  ...
  static const _introHiddenKey = 'intro_pa_atteintes_involontaires';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_atteintes_involontaires',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_atteintes_involontaires',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Atteintes involontaires',
                                description:
                                    'Distingue les homicides et blessures involontaires de leurs équivalents volontaires et identifie les éléments constitutifs de chaque infraction.',
