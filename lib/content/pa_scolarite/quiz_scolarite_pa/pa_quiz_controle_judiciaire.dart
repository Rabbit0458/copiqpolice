...
// PAGE
// ============================================================================
class QuizControleJudiciairePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/procedure_penale/quiz/controle_judiciaire';
  final String uid;
  final String email;

  const QuizControleJudiciairePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizControleJudiciairePagePA> createState() =>
      _QuizControleJudiciairePagePAState();
}

class _QuizControleJudiciairePagePAState
    extends State<QuizControleJudiciairePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_controle_judiciaire';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_controle_judiciaire',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_controle_judiciaire',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends le contrôle judiciaire comme alternative à la détention provisoire : conditions, obligations imposées et conséquences en cas de violation.',
