...
class QuizControleJudiciairePagePA extends StatefulWidget {
  ...
  @override
  State<QuizControleJudiciairePagePA> createState() => _QuizControleJudiciairePagePAState();
}

class _QuizControleJudiciairePagePAState extends State<QuizControleJudiciairePagePA>
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            description: 'Comprends le contrôle judiciaire comme alternative à la détention provisoire : conditions, obligations imposées et conséquences en cas de violation.',
