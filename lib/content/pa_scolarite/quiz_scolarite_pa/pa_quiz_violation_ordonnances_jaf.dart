...
class QuizViolationOrdonnancesJafPA extends StatefulWidget {
  ...
  const QuizViolationOrdonnancesJafPA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizViolationOrdonnancesJafPA> createState() =>
      _QuizViolationOrdonnancesJafPAState();
}

class _QuizViolationOrdonnancesJafPAState
    extends State<QuizViolationOrdonnancesJafPA>
  ...
  static const _introHiddenKey = 'intro_pa_violation_ordonnances_jaf';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_violation_ordonnances_jaf',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_violation_ordonnances_jaf',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Comprends les ordonnances du juge aux affaires familiales et les infractions liées à leur violation : résidence, garde, pension alimentaire.',
