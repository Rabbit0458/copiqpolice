...
class QuizAtteinteAdministrationPA extends StatefulWidget {
  ...
  @override
  State<QuizAtteinteAdministrationPA> createState() =>
      _QuizAtteinteAdministrationPAState();
}

class _QuizAtteinteAdministrationPAState
    extends State<QuizAtteinteAdministrationPA>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_atteintes_administration',
