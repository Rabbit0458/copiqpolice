...
class QuizCadresPrincipalesPagePA extends StatefulWidget {
  ...
  @override
  State<QuizCadresPrincipalesPagePA> createState() =>
      _QuizCadresPrincipalesPagePAState();
}

class _QuizCadresPrincipalesPagePAState
    extends State<QuizCadresPrincipalesPagePA>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_page_cadres_juridique',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Identifie les différents cadres d’intervention policière : conditions de déclenchement, spécificités et actes autorisés dans chacun.',
