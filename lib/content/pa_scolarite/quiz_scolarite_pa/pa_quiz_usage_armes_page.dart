...
// PAGE
// ============================================================================
class QuizUsageArmesPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/usagearmes';
  final String uid;
  final String email;

  const QuizUsageArmesPagePA({super.key, required this.uid, required this.email});

  @override
  State<QuizUsageArmesPagePA> createState() => _QuizUsageArmesPagePAState();
}

class _QuizUsageArmesPagePAState extends State<QuizUsageArmesPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_usage_armes';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_usage_armes_page',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            description: 'Maîtrise le cadre légal de l’usage des armes par la police : conditions légales, jurisprudence et nouvelles dispositions de la loi.',
