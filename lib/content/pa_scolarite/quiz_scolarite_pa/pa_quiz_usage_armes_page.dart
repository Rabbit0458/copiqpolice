  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_usage_armes_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise le cadre légal de l’usage des armes par la police : conditions légales, jurisprudence et nouvelles dispositions de la loi.',
