  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_mineurs_famille',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Étudie les dispositions relatives aux mineurs dans le contexte familial : protection de l’enfance, garde et infractions spécifiques.',
