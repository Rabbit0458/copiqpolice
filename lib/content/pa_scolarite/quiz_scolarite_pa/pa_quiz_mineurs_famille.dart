...
// PAGE
// ============================================================================
class QuizMineursFamillePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName =
      '/pa/mineurs_famille_pages/quiz/pa_quiz_mineurs_famille';
  final String uid;
  final String email;

  const QuizMineursFamillePA({super.key, required this.uid, required this.email});

  @override
  State<QuizMineursFamillePA> createState() => _QuizMineursFamillePAState();
}

class _QuizMineursFamillePAState extends State<QuizMineursFamillePA>
  ...
  static const _introHiddenKey = 'intro_pa_mineurs_famille';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_mineurs_famille',
                      ...
                      children: [
                        ...
                        if (_showIntro)
                          _IntroSplash(
                            ...
                            title: 'Mineurs et famille',
                            description: 'Étudie les dispositions relatives aux mineurs dans le contexte familial : protection de l’enfance, garde et infractions spécifiques.',
