...
// PAGE
// ============================================================================
class QuizAbusAutoritePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/nation/quiz/abus_autorite_particuliers';
  final String uid;
  final String email;

  const QuizAbusAutoritePA({super.key, required this.uid, required this.email});

  @override
  State<QuizAbusAutoritePA> createState() => _QuizAbusAutoritePAState();
}

class _QuizAbusAutoritePAState extends State<QuizAbusAutoritePA>
  ...
  static const _introHiddenKey = 'intro_pa_abus_autorite';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_abus_autorite',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise les infractions commises par des personnes dépositaires de l’autorité publique : abus de pouvoir, excès de fonctions et atteintes aux libertés.',
