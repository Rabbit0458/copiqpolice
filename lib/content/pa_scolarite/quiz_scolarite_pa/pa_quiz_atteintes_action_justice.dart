...
// PAGE
// ============================================================================
class QuizAtteinteActionJusticePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/nation/quiz/atteintes_action_justice';
  final String uid;
  final String email;

  const QuizAtteinteActionJusticePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizAtteinteActionJusticePA> createState() =>
      _QuizAtteinteActionJusticePAState();
}

class _QuizAtteinteActionJusticePAState
    extends State<QuizAtteinteActionJusticePA>
  ...
  static const _introHiddenKey = 'intro_pa_atteintes_action_justice';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_atteintes_action_justice',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_atteintes_action_justice',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Approfondis les infractions qui portent atteinte à l’autorité de la justice : entrave, faux témoignage, subornation de témoin.',
