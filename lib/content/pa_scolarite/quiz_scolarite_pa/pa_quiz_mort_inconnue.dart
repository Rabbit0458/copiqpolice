...
// PAGE
// ============================================================================
class QuizMortInconnuePagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/mort_inconnue';
  final String uid;
  final String email;

  const QuizMortInconnuePagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizMortInconnuePagePA> createState() => _QuizMortInconnuePagePAState();
}

class _QuizMortInconnuePagePAState extends State<QuizMortInconnuePagePA>
  ...
  static const _introHiddenKey = 'intro_pa_mort_inconnue';
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_mort_inconnue',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                title: 'Mort inconnue',
                                description:
                                    'Approfondis les procédures relatives aux morts inconnues ou suspectes : constatations initiales, réquisitions et enquête judiciaire.',
