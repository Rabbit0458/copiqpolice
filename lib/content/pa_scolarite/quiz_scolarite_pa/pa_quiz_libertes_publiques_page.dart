...
// PAGE
// ============================================================================
class QuizLibertesPubliquesPagePA extends StatefulWidget {
  static const String grade = 'pa';
  static const String routeName = '/pa/generalites/quiz/libertes_publiques';
  final String uid;
  final String email;

  const QuizLibertesPubliquesPagePA({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizLibertesPubliquesPagePA> createState() =>
      _QuizLibertesPubliquesPagePAState();
}

class _QuizLibertesPubliquesPagePAState
    extends State<QuizLibertesPubliquesPagePA>
  ...
  static const _introHiddenKey = 'intro_pa_libertes_publiques';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_libertes_publiques_page',
  ...
  Future<void> _insertReport({
    ...
    await _sb.from('report_question').insert(<String, dynamic>{
      ...
      'source_file': 'pa_quiz_libertes_publiques_page',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Découvre les grandes catégories de libertés publiques, leur fondement constitutionnel et les équilibres entre liberté et ordre public.',
