...
class QuizDispositionsApplicablesMineursPA extends StatefulWidget {
  ...
  @override
  State<QuizDispositionsApplicablesMineursPA> createState() =>
      _QuizDispositionsApplicablesMineursPAState();
}

class _QuizDispositionsApplicablesMineursPAState
    extends State<QuizDispositionsApplicablesMineursPA>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_dispositions_applicables_mineurs',
                          ...
                          children: [
                            ...
                            if (_showIntro)
                              _IntroSplash(
                                ...
                                description:
                                    'Maîtrise les règles spécifiques aux mineurs auteurs ou victimes : ordonnance de 1945, CJPM, retenue et garde à vue des mineurs.',
