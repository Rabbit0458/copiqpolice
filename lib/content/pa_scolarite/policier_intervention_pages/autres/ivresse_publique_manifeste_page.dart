...
class PaIvressePubliqueManifestePage extends StatelessWidget {
  const PaIvressePubliqueManifestePage({super.key});

  static const String routeName =
      '/pa/dps_dpg/policier_intervention/autres/ipm';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/policier_intervention_pages/autres/ivresse_publique_manifeste_page.dart",
            "f00001",
            'Retour',
          ),
        ),
