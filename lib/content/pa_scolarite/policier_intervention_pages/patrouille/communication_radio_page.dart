...
class PaCommunicationRadioPage extends StatelessWidget {
  const PaCommunicationRadioPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/policier_intervention/patrouille/communication-radio';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/policier_intervention_pages/patrouille/communication_radio_page.dart",
            "f00001",
            'Retour',
          ),
        ),
