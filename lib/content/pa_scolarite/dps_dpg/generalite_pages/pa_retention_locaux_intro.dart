// lib/gpx_scolarite_pages/generalite_pages/RetentionLocaux_intro_page.dart
import 'dart:async';
...
///  Adapté depuis ta page "Classification" pour ouvrir RetentionLocauxPage
///
///  ✅ Une SEULE image de fond (zéro doublon)
///  ✅ Adaptation parfaite : fitHeight + alignment ajusté
///  ✅ Titre "écriture IA" + glow
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers RetentionLocauxPage
///  ✅ Minimaliste, moderne, 2025
///  ✅ Compatible Flutter 3.24+ (Color.withValues)
///
///  🔧 Où modifier RAPIDEMENT :
///   - _kBackgroundPath : chemin de l'image
///   - _kTargetRouteName : route de la page contenu (RetentionLocauxPage.routeName)
///   - _kBackgroundAlignment : cadrage vertical
///   - _kFit : BoxFit.fitHeight / cover
/// ==============================================================
class PaRetentionLocauxIntroPage extends StatefulWidget {
  const PaRetentionLocauxIntroPage({super.key});
  ...
  @override
  State<PaRetentionLocauxIntroPage> createState() =>
      _RetentionLocauxIntroPageState();
}

class _RetentionLocauxIntroPageState extends State<PaRetentionLocauxIntroPage>
  ...
  static const String _kTargetRouteName = RetentionLocauxContenuPage.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/pa_scolarite/dps_dpg/generalite_pages/pa_retention_locaux_intro.dart",
    "f00001",
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible (RetentionLocauxPage)
// --------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_RetentionLocauxIntroPageState._kTargetRouteName),
    );
