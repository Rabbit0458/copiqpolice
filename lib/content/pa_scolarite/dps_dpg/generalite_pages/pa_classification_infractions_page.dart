...
//  Recode ENTIEREMENT (A → Z) sous les NOMS DEMANDES :
//    - PaClassificationInfractionsPage
//    - _ClassificationInfractionsPageState
//
//  ✅ Une SEULE image de fond (zéro doublon)
//  ✅ Adaptation parfaite : fitHeight + alignment ajusté
//  ✅ Titre "écriture IA" + glow
//  ✅ Sous-texte en fade
//  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers votre page contenu
//  ✅ Minimaliste, moderne, 2025
//  ✅ Compatible Flutter 3.24+ (Color.withValues)
//
//  🔧 Où modifier RAPIDEMENT :
//   - _kBackgroundPath : chemin de l'image
//   - _kTargetRouteName : route de la page contenu (à ouvrir après "COMMENCER")
//   - _kBackgroundAlignment : cadrage vertical (réduit ou augmente la sensation de zoom)
//   - _kFit : BoxFit.fitHeight (parfait pour éviter le zoom) / cover si vous préférez un rendu "ciné"
// ==============================================================

class PaClassificationInfractionsPage extends StatefulWidget {
  const PaClassificationInfractionsPage({super.key});

  // Route actuelle de la page (si vous naviguez ici depuis ailleurs)
  static const String routeName =
      '/pa/dps_dpg/socle_initial/generalites/classification_infractions';

  @override
  State<PaClassificationInfractionsPage> createState() =>
      _ClassificationInfractionsPageState();
}

class _ClassificationInfractionsPageState
    extends State<PaClassificationInfractionsPage>
    with TickerProviderStateMixin {
  // === EDITABLE — CONFIG ===
  static const String _kBackgroundPath = 'assets/images/background.jpeg';
  static const Alignment _kBackgroundAlignment = Alignment(0, -0.50);
  static const BoxFit _kFit = BoxFit.cover;

  /// Cible : la page contenu "vraie fiche cours"
  static const String _kTargetRouteName =
      PaClassificationInfractionsContenuPageLoiPenal.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/pa_scolarite/dps_dpg/generalite_pages/pa_classification_infractions_page.dart",
    "f00001",
...
/// --------------------------------------------------------------
///  Bouton retour réutilisable partout
/// --------------------------------------------------------------
class CopiqHeroBackButton extends StatelessWidget {
  ...
  /// Permet d’override la couleur du fond si besoin
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              onTap: () {
                ...
                if (nav.canPop()) {
                  nav.pop(); // 👈 revient juste à la page précédente
                }
              },
              child: Container(
...
// --------------------------------------------------------------
//  Shim de redirection vers la route cible que VOUS définissez
// --------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  const _RouteShimToTarget();
  @override
  Widget build(BuildContext context) {
    // Remplace la page par la route contenu définie plus haut
    Future.microtask(
      () => Navigator.of(context).pushReplacementNamed(
        _ClassificationInfractionsPageState._kTargetRouteName,
      ),
    );
