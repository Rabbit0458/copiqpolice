...
/// ==============================================================
class PaTentativeIntroPage extends StatefulWidget {
  const PaTentativeIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName =
      '/pa/dps_dpg/socle_initial/generalites/tentative_intro';

  @override
  State<PaTentativeIntroPage> createState() => _TentativeIntroPageState();
}

class _TentativeIntroPageState extends State<PaTentativeIntroPage>
  ...
  static const String _kTargetRouteName = TentativeContenuPagePA.routeName;
  ...
  static final String _titleFull = ScolariteText.value(
    "lib/content/pa_scolarite/dps_dpg/generalite_pages/pa_tentative_intro_page.dart",
    "f00001",
    'LA TENTATIVE',
  );
  int _typedCount = 0;
