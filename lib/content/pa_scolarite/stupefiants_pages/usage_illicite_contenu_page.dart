...
class PaStupefiantsUsageIllicitePage extends StatelessWidget {
  const PaStupefiantsUsageIllicitePage({super.key});

  static const String routeName = '/pa/dps_dpg/stupefiants/usage_illicite';
