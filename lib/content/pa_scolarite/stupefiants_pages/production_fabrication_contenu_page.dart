...
class PaStupefiantsProductionFabricationPage extends StatelessWidget {
  const PaStupefiantsProductionFabricationPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/stupefiants/production_fabrication';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/stupefiants_pages/production_fabrication_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
