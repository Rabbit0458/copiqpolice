...
class PaStupefiantsImportExportPage extends StatelessWidget {
  const PaStupefiantsImportExportPage({super.key});

  static const String routeName = '/pa/dps_dpg/stupefiants/import_export';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/stupefiants_pages/import_export_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
