      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle("2.1.1 — Le principe"),
              _Paragraph.rich([
                TextSpan(text: "Le Code pénal, dans son "),
                TextSpan(
              ...
              _Paragraph.rich([
                ...
                TextSpan(text: " (cf. tableau)."),
              ]),

              SizedBox(height: 14),
              _SubTitle("2.1.2 — Les intérêts de cette classification"),

              _SubTitle("2.1.2.1 — Pour les règles de fond"),
              _Paragraph.rich([
                TextSpan(text: "✓ "),
                TextSpan(
                  text: "La tentative",
              ...
              SizedBox(height: 14),
              _SubTitle("2.1.2.2 — Pour la prescription"),
              _SubTitle("2.1.2.2.1 — Prescription de l’action publique"),
              _Paragraph(
              ...
              _Paragraph("✓ 20 ans en cas de délits de guerre."),
              SizedBox(height: 6),
              _Paragraph("✓ 30 ans en cas de crimes de guerre."),
              SizedBox(height: 6),
              ...
              SizedBox(height: 14),
              _SubTitle("2.1.2.2.2 — Prescription de la peine"),
              _Paragraph(
              ...
              SizedBox(height: 14),
              _SubTitle("2.1.2.3 — Pour les règles de procédure"),
              _SubTitle("2.1.2.3.1 — Les juridictions compétentes"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("2.1.2.3.2 — Le cadre d’enquête"),
              _Paragraph(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              SizedBox(height: 10),
              _SubTitle("2.2.1.2 — Intérêts de la distinction"),
              _SubTitle("2.2.1.2.1 — Quant au régime applicable"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("2.2.2.2 — Intérêts de la distinction"),
              _Paragraph(
              ...
              _SubTitle("2.2.3.1 — Définition de l’infraction militaire"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("2.2.3.2 — Conséquences de la distinction"),
              _SubTitle("2.2.3.2.1 — Quant aux règles de fond"),
              _Paragraph(
                "✓ Il existe des peines spécifiques comme la destitution et la perte du grade.",
              ),
              SizedBox(height: 10),
              _SubTitle("2.2.3.2.2 — Quant aux règles de forme"),
              _Paragraph(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _SubTitle("2.3.1.1 — Infractions de commission"),
              _Paragraph(
                "Elles consistent en la réalisation d’un acte prohibé par la loi.",
              ),

              SizedBox(height: 10),
              _SubTitle("2.3.1.2 — Infractions d’omission"),
              _Paragraph(
              ...
              SizedBox(height: 12),
              _SubTitle("2.3.2.2 — Intérêts de la distinction"),
              _SubTitle("2.3.2.2.1 — Quant à la prescription"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("2.3.2.2.3 — Quant à la compétence du tribunal"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("2.3.2.2.4 — Quant à l’amnistie"),
              _Paragraph(
              ...
              SizedBox(height: 12),
              _SubTitle("2.3.3.2 — Intérêts de la distinction"),
              _SubTitle("2.3.3.2.1 — Prescription de l’action publique"),
              _Paragraph(
              ...
              SizedBox(height: 10),
              _SubTitle("2.3.3.2.2 — Application de la loi nouvelle"),
              _Paragraph(
