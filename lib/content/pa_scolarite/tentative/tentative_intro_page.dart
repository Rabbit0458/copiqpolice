...
/// ==============================================================
class TentativeIntroPagePA extends StatefulWidget {
  const TentativeIntroPagePA({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName = '/pa/generalites/tentative_intro';

  @override
  State<TentativeIntroPagePA> createState() => _TentativeIntroPagePAState();
}

class _TentativeIntroPagePAState extends State<TentativeIntroPagePA>
...
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_TentativeIntroPagePAState._kTargetRouteName),
    );
