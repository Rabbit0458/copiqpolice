...
class PaObtentionIndueDocumentAdministratifPage extends StatelessWidget {
  const PaObtentionIndueDocumentAdministratifPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_nation_pages/faux_usage_faux/obtention_indue_document_administratif_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
