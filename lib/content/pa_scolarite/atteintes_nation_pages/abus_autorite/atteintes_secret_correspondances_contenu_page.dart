...
class PaAtteintesSecretCorrespondancesPage extends StatelessWidget {
  const PaAtteintesSecretCorrespondancesPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_nation_pages/abus_autorite/atteintes_secret_correspondances_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
