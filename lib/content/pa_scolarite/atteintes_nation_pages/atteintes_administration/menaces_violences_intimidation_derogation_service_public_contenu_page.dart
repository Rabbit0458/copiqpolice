...
class PaMenacesViolencesIntimidationDerogationServicePublicPage
    extends StatelessWidget {
  const PaMenacesViolencesIntimidationDerogationServicePublicPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/atteintes_nation_pages/atteintes_administration/menaces_violences_intimidation_derogation_service_public_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
