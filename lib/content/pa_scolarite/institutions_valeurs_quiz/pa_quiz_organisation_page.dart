...
class PaQuizOrganisationPnPage extends StatefulWidget {
  static const String routeName = '/pa/institution/organisation_pn/quiz';
  final String uid;
  final String email;

  const PaQuizOrganisationPnPage({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizOrganisationPnPage> createState() => _PaQuizOrganisationPnPageState();
}

class _PaQuizOrganisationPnPageState extends State<PaQuizOrganisationPnPage>
  ...
  Future<void> _saveAnswer({
    ...
    try {
      await _sb.from('quiz_organisation_pn_pa').insert({
        'user_uid': widget.uid,
        'email': widget.email,
        'question': question,
