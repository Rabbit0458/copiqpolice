...
class PaQuizAccueilPublicPage extends StatefulWidget {
  static const String routeName = '/pa/institution/accueil_public/quiz';
  final String uid;
  final String email;

  const PaQuizAccueilPublicPage({super.key, required this.uid, required this.email});

  @override
  State<PaQuizAccueilPublicPage> createState() => _PaQuizAccueilPublicPageState();
}

class _PaQuizAccueilPublicPageState extends State<PaQuizAccueilPublicPage>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // ✅ Image de la widget.question (galon / grade)
          if (widget.question.questionImageAsset != null &&
              widget.question.questionImageAsset!.isNotEmpty) ...[
            ...
            ClipRRect(
              ...
              child: Container(
                ...
                child: Image.asset(
                  widget.question.questionImageAsset!,
                  fit: BoxFit.contain,
                ),
              ),
            ),
