...
class PaQuizDeontologiePage extends StatefulWidget {
  static const String routeName = '/pa/institution/deontologie/quiz';
  final String uid;
  final String email;

  const PaQuizDeontologiePage({super.key, required this.uid, required this.email});

  @override
  State<PaQuizDeontologiePage> createState() => _PaQuizDeontologiePageState();
}

class _PaQuizDeontologiePageState extends State<PaQuizDeontologiePage>
