...
class PaPPChambreInstructionPage extends StatelessWidget {
  const PaPPChambreInstructionPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/procedure_penale_pages/pp_chambre_instruction.dart",
            "f00001",
