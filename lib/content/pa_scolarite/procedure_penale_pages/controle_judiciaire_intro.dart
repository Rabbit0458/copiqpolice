...
/// ==============================================================
class PaControleJudiciaireIntro extends StatefulWidget {
  const PaControleJudiciaireIntro({super.key});
  ...
  @override
  State<PaControleJudiciaireIntro> createState() =>
      _ControleJudiciaireIntroState();
}

class _ControleJudiciaireIntroState extends State<PaControleJudiciaireIntro>
  ...
  static const String _kTargetRouteName = PaControleJudiciaireContenu.routeName;
  ...
  static const String _titleFull = 'LE CONTRÔLE JUDICAIRE';
  int _typedCount = 0;
  Timer? _typeTimer;
...
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_ControleJudiciaireIntroState._kTargetRouteName),
    );
