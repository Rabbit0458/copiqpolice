...
class PaPPInstructionOuverturePage extends StatelessWidget {
  const PaPPInstructionOuverturePage({super.key});
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              // ---------------------------------------------
              _SubTitle("2.2.1 – Par le ministère public"),
              ...
              // ---------------------------------------------
              _SubTitle("2.2.2 – Par la victime"),
              ...
              _Paragraph.rich([
                TextSpan(text: "Cette obligation résulte de "),
                TextSpan(
