...
class PaJuridictionsPrincipesGenerauxPage extends StatelessWidget {
  const PaJuridictionsPrincipesGenerauxPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ScolariteText.value(
            "lib/content/pa_scolarite/procedure_penale_pages/juridictions_principes_generaux_page.dart",
            "f00001",
