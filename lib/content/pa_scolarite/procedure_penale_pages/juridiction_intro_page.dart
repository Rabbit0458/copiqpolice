...
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers JuridictionContenuPage
///  ✅ Bouton retour réutilisable : CopiqHeroBackButton
/// ==============================================================
class PaJuridictionIntroPage extends StatefulWidget {
  const PaJuridictionIntroPage({super.key});

  /// Route (si tu veux l’ouvrir par nom)
  static const String routeName =
      '/pa/dps_dpg/procedure_penale/juridictions_intro';

  @override
  State<PaJuridictionIntroPage> createState() => _JuridictionIntroPageState();
}

class _JuridictionIntroPageState extends State<PaJuridictionIntroPage>
  ...
  static const String _kTargetRouteName = PaJuridictionContenuPage.routeName;
  ...
  static const String _titleFull = 'LES JURIDICTIONS PÉNALES';
  int _typedCount = 0;
  Timer? _typeTimer;
              ...
              child: Column(
                children: [
                  ...
                  FadeTransition(
                    ...
                    child: Text(
                      "Comprendre l'organisation des juridictions pénale",
...
/// ------------------------------------------------------------------
/// Shim de redirection vers la route cible (JuridictionContenuPage)
/// ------------------------------------------------------------------
class _RouteShimToTarget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(
        context,
      ).pushReplacementNamed(_JuridictionIntroPageState._kTargetRouteName),
    );
