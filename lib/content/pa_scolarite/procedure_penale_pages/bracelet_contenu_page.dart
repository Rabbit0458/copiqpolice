...
class PaBraceletMaisonContenuPage extends StatelessWidget {
  const PaBraceletMaisonContenuPage({super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/procedure_penale_pages/bracelet_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
