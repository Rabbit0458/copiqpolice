...
class PaPPAutoritesInvestiesPJOccasionnellesPage extends StatelessWidget {
  const PaPPAutoritesInvestiesPJOccasionnellesPage({super.key});
              ...
              _ConditionCard(
                ...
                children: const [
                  ...
                  _Paragraph.rich([
                    ...
                    TextSpan(text: '. Cette mission s’exerce :'),
                  ]),
                  SizedBox(height: 6),
                  _BulletPoint(
                    text:
                  ...
                  _SubTitle('2.1.3 Direction de la police judiciaire'),
                  _Paragraph.rich([
                    TextSpan(
                      text:
                  ...
                  _SubTitle('2.1.4 Compétence territoriale du procureur'),
                  _Paragraph.rich([
                    TextSpan(
                      text:
