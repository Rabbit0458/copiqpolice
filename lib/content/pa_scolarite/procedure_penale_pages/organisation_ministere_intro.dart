...
///  ✅ Sous-texte en fade
///  ✅ Bouton "COMMENCER" (glow/pulse) → navigation vers OrganisationHierarchiqueContenuPage
///  ✅ Bouton retour réutilisable : CopiqHeroBackButton
/// ==============================================================
class PaOrganisationHierarchiqueIntroPage extends StatefulWidget {
  const PaOrganisationHierarchiqueIntroPage({super.key});
  ...
  @override
  State<PaOrganisationHierarchiqueIntroPage> createState() =>
      _OrganisationHierarchiqueIntroPageState();
}

class _OrganisationHierarchiqueIntroPageState
    extends State<PaOrganisationHierarchiqueIntroPage>
    with TickerProviderStateMixin {
  // === EDITABLE — CONFIG ===
  // Change l’image si besoin (par ex. 'assets/images/hierarchie.jpeg')
  static const String _kBackgroundPath = 'assets/images/cat_hierarchie.jpg';
  ...
  static const String _kTargetRouteName = PaPPOrganisationMinisterePublicContenuPage.routeName;
              ...
              child: Column(
                children: [
                  ...
                  FadeTransition(
                    ...
                    child: Text(
                      "Comprendre l'organisation hiérarchique du ministère public",
...
/// ------------------------------------------------------------------
/// Shim de redirection vers la route cible (OrganisationHierarchiqueContenuPage)
/// ------------------------------------------------------------------
  ...
  Widget build(BuildContext context) {
    Future.microtask(
      () => Navigator.of(context).pushReplacementNamed(
        _OrganisationHierarchiqueIntroPageState._kTargetRouteName,
      ),
    );
