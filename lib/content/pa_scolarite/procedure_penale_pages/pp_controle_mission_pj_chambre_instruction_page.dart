...
class PaPPControleMissionPJChambreInstructionPage extends StatelessWidget {
  const PaPPControleMissionPJChambreInstructionPage({super.key});
            ...
            children: [
              ...
              _ConditionCard(
                ...
                children: const [
                  ...
                  _BulletPoint(text: 'le procureur général ;'),
                  _BulletPoint(
                    text:
                  ...
                  _SubTitle('3.2.2 En raison du comportement'),
                  _Paragraph.rich([
                    TextSpan(
                      text:
