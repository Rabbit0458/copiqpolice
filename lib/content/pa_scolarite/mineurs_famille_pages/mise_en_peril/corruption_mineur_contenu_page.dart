...
class PaCorruptionMineurPage extends StatelessWidget {
  const PaCorruptionMineurPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              _SubTitle("A) Un auteur des faits"),
              _Paragraph(
              ...
              _SubTitle("B) Une victime mineure"),
              _Paragraph(
              ...
              _SubTitle("C) Un acte de corruption"),
              _Paragraph(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              SizedBox(height: 12),
              _SubTitle("Volonté de corrompre la victime"),
              _Paragraph(
          ...
          _ConditionCard(
            ...
            children: const [
              ...
              _Paragraph.rich([
                ...
                TextSpan(text: "OUI — conformément à "),
                TextSpan(
