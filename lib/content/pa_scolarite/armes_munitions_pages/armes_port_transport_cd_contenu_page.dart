...
class PaArmesPortTransportCDPage extends StatelessWidget {
  const PaArmesPortTransportCDPage({super.key});

  static const String routeName =
      '/pa/dps_dpg/armes_munitions_pages/armes_port_transport_cd';
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          tooltip: ScolariteText.value(
            "lib/content/pa_scolarite/armes_munitions_pages/armes_port_transport_cd_contenu_page.dart",
            "f00001",
            'Retour',
          ),
        ),
