...
// Copie adaptée de lib/content/gpx_exam/psycotechniques/quiz_tests_psycotechniques_calcul.dart
...
final List<PaQuizQuestion> paQuestionPsycotechniquesCalcul = [
  const PaQuizQuestion(
...
// PAGE
// ============================================================================
class PaQuizPsycotechniquesCalcul extends StatefulWidget {
  static const String routeName =
      '/pa_exam/concours/tests_psychotechniques/calcul_rapide';
  final String uid;
  final String email;

  const PaQuizPsycotechniquesCalcul({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizPsycotechniquesCalcul> createState() =>
      _PaQuizPsycotechniquesCalculState();
}

class _PaQuizPsycotechniquesCalculState
    extends State<PaQuizPsycotechniquesCalcul>
    with TickerProviderStateMixin {
  // Page & data
  late final PageController _page;
  late math.Random _rng;
  late List<PaQuizQuestion> _qs;
  ...
  void _seedAndShuffle() {
    ...
    final pool = useAll
        ? paQuestionPsycotechniquesCalcul
        : paQuestionPsycotechniquesCalcul
              .where((q) => q.difficulty == _selectedDifficulty)
              .toList();

    _qs = List<PaQuizQuestion>.from(pool);
    _qs.shuffle(_rng);
    ...
    try {
      final res = await _sb
          ...
          .insert({
            ...
            'uid': widget.uid,
            'email': widget.email,
            'module_name': 'PA - Tests psychotechniques - Calcul',
            'quiz_name': 'PA - Quiz tests psychotechniques calcul',
            'score': 0,
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_tests_psycotechniques_calcul',
