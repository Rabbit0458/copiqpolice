...
// Copie adaptée de lib/content/gpx_exam/psycotechniques/attention_visuelle_page.dart
...
class PaAttentionVisuellePage extends StatefulWidget {
  const PaAttentionVisuellePage({super.key});

  static const String routeName =
      '/pa_exam/concours/tests_psychotechniques/attention_visuelle';

  @override
  State<PaAttentionVisuellePage> createState() =>
      _PaAttentionVisuellePageState();
}

class _PaAttentionVisuellePageState extends State<PaAttentionVisuellePage>
  ...
  static const String _introHiddenKey =
      'pa_attention_visuelle_intro_hidden_forever_v3';
  ...
  Future<void> _insertReportAttentionVisuelle({
    ...
    final payload = <String, dynamic>{
      ...
      'module': (q['module'] ?? 'pa_psychotechnique').toString(),
      ...
      'message': message,
      'page': PaAttentionVisuellePage.routeName,
      'status': 'new',
    };
...
class _Halo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        final t = ctrl.value;
        final shiftX = dx + 8 * sin(2 * pi * t);
        final shiftY = dy + 8 * cos(2 * pi * t);
      ...
      children: [
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) {
            ...
            final remaining = max(
              0,
              (_PaAttentionVisuellePageState.questionDuration * (1 - progress))
                  .ceil(),
            );
