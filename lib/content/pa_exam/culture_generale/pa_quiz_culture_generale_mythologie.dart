...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_mythologie.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleMythologie extends StatefulWidget {
  static const String routeName =
      '/pa_exam/concours/culture_generale_mythologie';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleMythologie({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleMythologie> createState() =>
      _PaQuizCultureGeneraleMythologieState();
}

class _PaQuizCultureGeneraleMythologieState
    extends State<PaQuizCultureGeneraleMythologie>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Mythologie';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_mythologie',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale mythologie',
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb.from('quiz_culture_generale_mythologie_pages').insert(payload);
    } catch (e, st) {
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleMythologie.routeName,
      'status': 'new',
    };
