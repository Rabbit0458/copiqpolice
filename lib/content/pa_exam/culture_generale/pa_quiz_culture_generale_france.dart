...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_france.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneralFrance extends StatefulWidget {
  static const String routeName = '/pa_exam/concours/culture_generale_francais';

  final String uid;
  final String email;

  const PaQuizCultureGeneralFrance({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneralFrance> createState() =>
      _PaQuizCultureGeneralFranceState();
}

class _PaQuizCultureGeneralFranceState extends State<PaQuizCultureGeneralFrance>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_france',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale France',
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneralFrance.routeName,
      'status': 'new',
    };
