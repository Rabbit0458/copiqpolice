...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_musique.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleMusique extends StatefulWidget {
  static const String routeName = '/pa_exam/concours/culture_generale_musique';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleMusique({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleMusique> createState() =>
      _PaQuizCultureGeneraleMusiqueState();
}

class _PaQuizCultureGeneraleMusiqueState
    extends State<PaQuizCultureGeneraleMusique>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Musique';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_musique',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale musique',
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb.from('quiz_culture_generale_musique_pages').insert(payload);
    } catch (e, st) {
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleMusique.routeName,
      'status': 'new',
    };
