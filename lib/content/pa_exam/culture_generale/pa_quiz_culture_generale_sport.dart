...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_sport.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleSport extends StatefulWidget {
  static const String routeName = '/pa_exam/concours/culture_generale_sport';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleSport({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleSport> createState() =>
      _PaQuizCultureGeneraleSportState();
}

class _PaQuizCultureGeneraleSportState extends State<PaQuizCultureGeneraleSport>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Sport';
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale sport',
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb.from('quiz_culture_generale_sport_pages').insert(payload);
    } catch (e, st) {
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleSport.routeName,
      'status': 'new',
    };
