...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_cinema.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleCinema extends StatefulWidget {
  static const String routeName = '/pa_exam/concours/culture_generale_cinema';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleCinema({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleCinema> createState() =>
      _PaQuizCultureGeneraleCinemaState();
}

class _PaQuizCultureGeneraleCinemaState
    extends State<PaQuizCultureGeneraleCinema>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_cinema',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale cinéma',
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleCinema.routeName,
      'status': 'new',
    };
