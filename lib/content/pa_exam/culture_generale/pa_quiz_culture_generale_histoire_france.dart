...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_histoire_france.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleHistoireFrance extends StatefulWidget {
  ...
  const PaQuizCultureGeneraleHistoireFrance({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleHistoireFrance> createState() =>
      _PaQuizCultureGeneraleHistoireFranceState();
}

class _PaQuizCultureGeneraleHistoireFranceState
    extends State<PaQuizCultureGeneraleHistoireFrance>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Histoire';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_histoire_france',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale histoire',
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb
          .from('quiz_culture_generale_histoire_france_pages')
          .insert(payload);
    } catch (e, st) {
      debugPrint(
        '❌ quiz_culture_generale_histoire_france_pages insert failed: $e',
      );
      debugPrint('STACK: $st');
    }
  }
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleHistoireFrance.routeName,
      'status': 'new',
    };
