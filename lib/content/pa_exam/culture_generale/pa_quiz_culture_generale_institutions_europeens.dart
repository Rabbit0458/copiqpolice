...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_institutions_europeens.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneralInstitutionsEuropeenes extends StatefulWidget {
  ...
  const PaQuizCultureGeneralInstitutionsEuropeenes({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneralInstitutionsEuropeenes> createState() =>
      _PaQuizCultureGeneralInstitutionsEuropeenesState();
}

class _PaQuizCultureGeneralInstitutionsEuropeenesState
    extends State<PaQuizCultureGeneralInstitutionsEuropeenes>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Institutions';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_institutions_europeens',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale institutions européennes',
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneralInstitutionsEuropeenes.routeName,
      'status': 'new',
    };
