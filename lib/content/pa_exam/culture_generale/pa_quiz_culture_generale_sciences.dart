...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_sciences.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleSciences extends StatefulWidget {
  static const String routeName = '/pa_exam/concours/culture_generale_sciences';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleSciences({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleSciences> createState() =>
      _PaQuizCultureGeneraleSciencesState();
}

class _PaQuizCultureGeneraleSciencesState
    extends State<PaQuizCultureGeneraleSciences>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Sciences';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_sciences',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale sciences',
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleSciences.routeName,
      'status': 'new',
    };
