...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_sante.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleSante extends StatefulWidget {
  static const String routeName = '/pa_exam/concours/culture_generale_sante';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleSante({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleSante> createState() =>
      _PaQuizCultureGeneraleSanteState();
}

class _PaQuizCultureGeneraleSanteState extends State<PaQuizCultureGeneraleSante>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Sante';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_sante',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale santé',
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleSante.routeName,
      'status': 'new',
    };
