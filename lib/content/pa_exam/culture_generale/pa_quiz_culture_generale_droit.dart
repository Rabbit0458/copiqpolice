...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_droit.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleDroit extends StatefulWidget {
  static const String routeName = '/pa_exam/concours/culture_generale_droit';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleDroit({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleDroit> createState() =>
      _PaQuizCultureGeneraleDroitState();
}

class _PaQuizCultureGeneraleDroitState extends State<PaQuizCultureGeneraleDroit>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_droit',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale droit',
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleDroit.routeName,
      'status': 'new',
    };
