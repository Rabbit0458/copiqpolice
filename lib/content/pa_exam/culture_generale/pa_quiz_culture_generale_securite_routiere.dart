...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_securite_routiere.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleSecuriteRoutiere extends StatefulWidget {
  ...
  const PaQuizCultureGeneraleSecuriteRoutiere({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleSecuriteRoutiere> createState() =>
      _PaQuizCultureGeneraleSecuriteRoutiereState();
}

class _PaQuizCultureGeneraleSecuriteRoutiereState
    extends State<PaQuizCultureGeneraleSecuriteRoutiere>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Securite';
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale sécurité routière',
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb.from('quiz_culture_generale_securite_routiere_pages').insert(payload);
    } catch (e, st) {
      debugPrint('❌ quiz_culture_generale_securite_routiere_pages insert failed: $e');
      debugPrint('STACK: $st');
    }
  }
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleSecuriteRoutiere.routeName,
      'status': 'new',
    };
...
class _QuestionCardState extends State<_QuestionCard>
  ...
  bool get _afficheSousTitre => _shouldShowSub(widget.question.sub);
