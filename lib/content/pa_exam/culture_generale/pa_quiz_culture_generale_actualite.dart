...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_actualite.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneraleActualite extends StatefulWidget {
  static const String routeName =
      '/pa_exam/concours/culture_generale_actualite';

  final String uid;
  final String email;

  const PaQuizCultureGeneraleActualite({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneraleActualite> createState() =>
      _PaQuizCultureGeneraleActualiteState();
}

class _PaQuizCultureGeneraleActualiteState
    extends State<PaQuizCultureGeneraleActualite>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Actualite';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_actualite',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale actualité',
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb.from('quiz_culture_generale_actualite_pages').insert(payload);
    } catch (e, st) {
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneraleActualite.routeName,
      'status': 'new',
    };
