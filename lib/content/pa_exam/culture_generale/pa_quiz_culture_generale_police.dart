...
// Copie adaptée de lib/content/gpx_exam/culture_generale/quiz_culture_generale_police.dart
...
// PAGE
// ============================================================================
class PaQuizCultureGeneralePolice extends StatefulWidget {
  static const String routeName =
      '/pa_exam/concours/culture_generale_police_securite';

  final String uid;
  final String email;

  const PaQuizCultureGeneralePolice({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<PaQuizCultureGeneralePolice> createState() =>
      _PaQuizCultureGeneralePoliceState();
}

class _PaQuizCultureGeneralePoliceState
    extends State<PaQuizCultureGeneralePolice>
    with TickerProviderStateMixin {
  // ===========================================================================
  // CONFIG QUIZ
  // ===========================================================================
  static const String _categoryNameDb = 'Police';
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'pa_quiz_culture_generale_police',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'PA - Quiz culture générale police',
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb.from('quiz_culture_generale_police_pages').insert(payload);
    } catch (e, st) {
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': PaQuizCultureGeneralePolice.routeName,
      'status': 'new',
    };
