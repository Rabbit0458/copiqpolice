...
// PAGE
// ============================================================================
class QuizCultureGeneraleGeographie extends StatefulWidget {
  static const String routeName =
      '/gpx_exam/concours/culture_generale_geographie';

  final String uid;
  final String email;

  const QuizCultureGeneraleGeographie({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCultureGeneraleGeographie> createState() =>
      _QuizCultureGeneraleGeographieState();
}

class _QuizCultureGeneraleGeographieState
    extends State<QuizCultureGeneraleGeographie>
  ...
  Future<void> _validate() async {
    ...
    unawaited(
      LearningAnswerHistoryService().record(
        ...
        quizKey: 'quiz_culture_generale_geographie',
  ...
  Future<void> _createHistoryOnStart() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'quiz_name': 'Quiz culture générale géographie',
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': QuizCultureGeneraleGeographie.routeName,
      'status': 'new',
    };
