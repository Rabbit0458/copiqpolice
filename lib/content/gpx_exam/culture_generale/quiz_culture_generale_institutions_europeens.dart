...
class QuizCultureGeneralInstitutionsEuropeenes extends StatefulWidget {
  static const String routeName = '/gpx_exam/concours/culture_generale_institutions_europeennes';
...
class _QuizCultureGeneralInstitutionsEuropeenesState extends State<QuizCultureGeneralInstitutionsEuropeenes>
  ...
  Future<void> _saveAnswer({
    ...
    try {
      ...
      await _sb.from('quiz_culture_generale_institutions_pages').insert(payload);
    } catch (e, st) {
      debugPrint('❌ quiz_culture_generale_institutions_pages insert failed: $e');
      debugPrint('STACK: $st');
    }
  }
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': QuizCultureGeneralInstitutionsEuropeenes.routeName,
      'status': 'new',
    };
