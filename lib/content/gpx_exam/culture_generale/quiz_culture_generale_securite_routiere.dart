...
class QuizCultureGeneraleSecuriteRoutiere extends StatefulWidget {
  static const String routeName = '/gpx_exam/concours/culture_generale_securite_routiere';
...
class _QuizCultureGeneraleSecuriteRoutiereState extends State<QuizCultureGeneraleSecuriteRoutiere>
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': QuizCultureGeneraleSecuriteRoutiere.routeName,
      'status': 'new',
    };
