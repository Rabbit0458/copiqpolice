...
class QuizCultureGeneraleActualite extends StatefulWidget {
  static const String routeName = '/gpx_exam/concours/culture_generale_actualite';
...
class _QuizCultureGeneraleActualiteState extends State<QuizCultureGeneraleActualite>
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': QuizCultureGeneraleActualite.routeName,
      'status': 'new',
    };
