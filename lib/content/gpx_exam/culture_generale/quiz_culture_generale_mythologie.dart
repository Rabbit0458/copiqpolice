...
class QuizCultureGeneraleMythologie extends StatefulWidget {
  static const String routeName = '/gpx_exam/concours/culture_generale_mythologie';
...
class _QuizCultureGeneraleMythologieState extends State<QuizCultureGeneraleMythologie>
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': QuizCultureGeneraleMythologie.routeName,
      'status': 'new',
    };
