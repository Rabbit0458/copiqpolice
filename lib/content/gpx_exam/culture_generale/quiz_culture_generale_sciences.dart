...
class QuizCultureGeneraleSciences extends StatefulWidget {
  static const String routeName = '/gpx_exam/concours/culture_generale_sciences';
...
class _QuizCultureGeneraleSciencesState extends State<QuizCultureGeneraleSciences>
  ...
  Future<void> _insertReportCultureGenerale({
    ...
    final payload = <String, dynamic>{
      ...
      'message': message,
      'page': QuizCultureGeneraleSciences.routeName,
      'status': 'new',
    };
