...
class GPXAdmissionPage extends StatelessWidget {
  const GPXAdmissionPage({super.key});

  static const String routeName = '/gpx_exam/concours/epreuves_gpx/admission';

  static const Color _lawRed = Color(0xFFE53935);

  // ⚠️ Remplace par TES vrais noms de fichiers (tu as mis “.png et .png”)
  // Dossier : assets/images/
  static const String _img1 = 'assets/images/admission_gpx_1.png';
  static const String _img2 = 'assets/images/admission_gpx_2.png';
  ...
  Widget build(BuildContext context) {
    ...
    final Color cardSport = isDark
        ? const Color(0xFF1D2A24)
        : const Color(0xFFF1FBF5);
    final Color cardOral = isDark
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text(
            "Admission — Épreuves sportives & entretien",
            style: GoogleFonts.fustat(
              fontWeight: FontWeight.w900,
              fontSize: 21,
              height: 1.15,
          ...
          _ConditionCard(
            ...
            children: const [
              _Paragraph(
                "L’admission du concours de gardien de la paix comporte :\n"
                "• des épreuves sportives (PHM + TECR)\n"
                "• un entretien devant jury.\n\n"
                "Les épreuves sportives sont éliminatoires : si tu es éliminé(e) au sport, "
                "tu ne seras pas convoqué(e) à l’oral.",
              ),
            ],
          ),
          ...
          // ✅ Référence réglementaire en haut (exigence respectée)
          _ConditionCard(
            title: "Références réglementaires (en haut)",
            cardColor: cardLegal,
            accent: accentBlue,
            titleColor: textMain,
            children: [
          ...
          // I — Sport
          _ConditionCard(
            title: "I — Épreuves sportives (PHM + TECR)",
            cardColor: cardSport,
            accent: accentGreen,
            titleColor: textMain,
            children: [
          ...
          // II — Oral
          _ConditionCard(
            title: "II — Entretien de recrutement avec le jury",
            cardColor: cardOral,
            accent: accentPink,
            titleColor: textMain,
            children: [
          ...
          // III — Conseils jury
          _ConditionCard(
            title: "III — Conseils pour l’oral (retour de jury)",
          ...
          // IV — Récap ultra lisible
          _ConditionCard(
            title: "IV — Récap rapide",
            cardColor: cardRecap,
            accent: accentGrey,
            titleColor: textMain,
            children: const [
              _BulletPoint(
                text:
                    "Sport : PHM + TECR — coef 4 — éliminatoire < 7/20 (à l’une des 2 épreuves).",
              ),
              _BulletPoint(
                text:
                    "Certificat médical obligatoire : moins de 3 mois (médecin de ton choix).",
              ),
              _BulletPoint(
                text:
                    "Oral : entretien 25 min (dont 5 min présentation) — coef 5 — éliminatoire < 5/20.",
              ),
              _BulletPoint(text: "Éliminé(e) au sport = pas d’oral."),
            ],
          ),
...
class _AdmissionPills extends StatelessWidget {
  const _AdmissionPills({
    required this.left,
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      spacing: 8,
      runSpacing: 8,
      children: [pill(left), pill(middle), pill(right)],
    );
  }
}
