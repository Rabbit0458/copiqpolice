...
class FichesAbcPage extends StatelessWidget {
  ...
  static const String routeName =
      '/gpx/pv_apj20/circulation_routiere/alcool/fiches_abc';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: const [
              ZoomableAssetImage(assetPath: 'assets/images/fiches_a.png'),
              SizedBox(height: 12),
              ZoomableAssetImage(assetPath: 'assets/images/fiches_bc.png'),
            ],
          ),
