...
class RequisitionExamenCliniquePrelevementExpertisePage
  ...
  const RequisitionExamenCliniquePrelevementExpertisePage({super.key});
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              _Paragraph.rich([
                ...
                const TextSpan(text: "• En cas de décès du conducteur : "),
                TextSpan(
          ...
          _ConditionCard(
            ...
            children: const [
              ZoomableAssetImage(
                assetPath:
                    'assets/images/requisition_examen_clinique_prelevement_expertise.png',
                heroTag: 'requisition_examen_clinique_prelevement_expertise',
              ),
            ],
          ),
        ],
