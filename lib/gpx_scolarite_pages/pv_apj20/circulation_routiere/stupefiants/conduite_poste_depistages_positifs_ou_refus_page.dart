...
class ConduitePosteDepistagesPositifsOuRefusPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Palette cards (cohérente + lisible)
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: const [
              ZoomableAssetImage(
                assetPath:
                    "assets/images/conduite_poste_depistages_positifs_ou_refus.png",
              ),
              SizedBox(height: 12),
              ZoomableAssetImage(
                assetPath:
                    "assets/images/conduite_poste_depistages_positifs_ou_refus_verso.png",
              ),
            ],
          ),
