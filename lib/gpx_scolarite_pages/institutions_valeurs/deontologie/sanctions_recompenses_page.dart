      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              _Paragraph.rich([
                const TextSpan(text: "Contrôle externe (qualité OPJ/APJ) : "),
                TextSpan(
              ...
              _Paragraph.rich([
                const TextSpan(text: "Contrôle par le Défenseur des droits : "),
                TextSpan(
                  text:
          ...
          _ConditionCard(
            ...
            children: [
              ...
              const _BulletPoint(text: "Abaissement d’échelon."),
              const _BulletPoint(
                text:
