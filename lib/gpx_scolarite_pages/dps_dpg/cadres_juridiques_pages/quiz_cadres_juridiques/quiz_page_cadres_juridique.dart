...
// PAGE
// ============================================================================
class QuizCadresPrincipalesPage extends StatefulWidget {
  static const String routeName =
      '/gpx/procedure_penale/quiz/cadres_juridiques_principales';
  final String uid;
  final String email;

  const QuizCadresPrincipalesPage({
    super.key,
    required this.uid,
    required this.email,
  });
  ...
  @override
  State<QuizCadresPrincipalesPage> createState() =>
      _QuizCadresPrincipalesPageState();
}

class _QuizCadresPrincipalesPageState extends State<QuizCadresPrincipalesPage>
