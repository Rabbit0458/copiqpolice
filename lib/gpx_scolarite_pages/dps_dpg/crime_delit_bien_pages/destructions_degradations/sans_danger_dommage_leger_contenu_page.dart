...
class SansDangerDommageLegerPage extends StatelessWidget {
  const SansDangerDommageLegerPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            accent: accentAmber,
            titleColor: textMain,
            children: const [_Paragraph("Aucune circonstance aggravante.")],
          ),
