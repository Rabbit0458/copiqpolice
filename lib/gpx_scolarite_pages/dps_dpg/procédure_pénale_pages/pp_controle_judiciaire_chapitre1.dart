...
class PPControleJudiciaireChapitre1Page extends StatelessWidget {
  const PPControleJudiciaireChapitre1Page({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              const _SubTitle('1.1 — Définition'),
              _Paragraph.rich([
                const TextSpan(
                  text:
              ...
              const _SubTitle('1.1.1 — Conditions de mise en œuvre'),
              _Paragraph.rich([
                const TextSpan(
                  text:
              ...
              const _SubTitle('1.1.2 — À qui s’applique-t-il ?'),
              const _Paragraph(
              ...
              const SizedBox(height: 10),
              const _BulletPoint(text: 'par le juge d’instruction ;'),
              const _BulletPoint(
                text: 'par le juge des libertés et de la détention ;',
              ),
              const _BulletPoint(text: 'par la chambre de l’instruction ;'),
              const _BulletPoint(
              ...
              const _SubTitle('1.2.1 — Décision du juge d’instruction'),
              _Paragraph.rich([
                const TextSpan(
                  text:
