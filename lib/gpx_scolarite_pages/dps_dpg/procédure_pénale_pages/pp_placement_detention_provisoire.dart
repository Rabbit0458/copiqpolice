...
class PPPlacementDetentionProvisoirePage extends StatelessWidget {
  const PPPlacementDetentionProvisoirePage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/procédure_pénale_pages/pp_placement_detention_provisoire';
