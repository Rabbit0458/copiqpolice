...
class PPControleMissionPJRoleProcureurGeneralPage extends StatelessWidget {
  const PPControleMissionPJRoleProcureurGeneralPage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/procédure_pénale_pages/pp_controle_mission_pj_role_procureur_general';
            ...
            children: [
              ...
              _ConditionCard(
                ...
                children: [
                  ...
                  const _SubTitle('1.2.2 Officiers non soumis à habilitation'),
                  const _Paragraph.rich([
                    TextSpan(
                      text:
                  ...
                  const _SubTitle('1.2.3 Le refus d’habilitation'),
                  _Paragraph.rich([
                    const TextSpan(
                      text:
                  ...
                  const _SubTitle('1.2.4 Suspension ou retrait d’habilitation'),
                  _Paragraph.rich([
                    const TextSpan(
                      text:
