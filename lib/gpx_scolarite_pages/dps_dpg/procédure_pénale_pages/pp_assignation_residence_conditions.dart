...
class PpAssignationResidenceConditionsPage extends StatelessWidget {
  const PpAssignationResidenceConditionsPage({super.key});
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              ...
              const _SubTitle('1.1.2 — Prononcé de la mesure'),
              const _Paragraph(
              ...
              const _SubTitle('1.2 — Objet de la mesure'),
              const _Paragraph(
