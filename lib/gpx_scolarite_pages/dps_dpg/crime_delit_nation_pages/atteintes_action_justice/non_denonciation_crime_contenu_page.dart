...
class NonDenonciationCrimePage extends StatelessWidget {
  const NonDenonciationCrimePage({super.key});

  static const String routeName =
      '/gpx_scolarite_pages/crime_delit_nation_pages/atteintes_action_justice/non_denonciation_crime';
        ...
        children: [
          ...
          _ConditionCard(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              _Paragraph.rich([
                const TextSpan(text: "Secret professionnel : "),
                TextSpan(
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: [
              const _SubTitle("A) Connaissance de la commission d’un crime"),
              const _Paragraph(
              ...
              const _SubTitle("B) Une abstention de dénonciation"),
              const _Paragraph(
              ...
              const _SubTitle("C) Révélation de l’existence du crime"),
              const _Paragraph(
              ...
              const _SubTitle("D) Objectif de la révélation"),
              const _Paragraph(
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: [
              const _SubTitle("S’abstenir volontairement de dénoncer"),
              const _Paragraph(
          ...
          _ConditionCard(
            ...
            children: [
              ...
              const _SubTitle("Immunité familiale & autres exceptions"),
              _NotaBox(
