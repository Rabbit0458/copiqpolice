...
class EscaladePage extends StatelessWidget {
  const EscaladePage({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                _ConditionCard(
                  ...
                  titleColor: titleColor,
                  children: [
                    const _SubTitle('2.1 - Un endroit clos'),
                    const _Paragraph(
                    ...
                    const SizedBox(height: 10),
                    const _SubTitle("2.2 - L'usage d'un moyen"),
                    const _Paragraph(
                ...
                _ConditionCard(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    _BulletPoint(text: "Le vol (article 311-5, 3° C.P.)."),
                    _BulletPoint(
                      text:
