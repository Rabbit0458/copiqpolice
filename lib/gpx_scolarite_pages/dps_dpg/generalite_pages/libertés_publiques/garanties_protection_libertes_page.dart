...
import 'package:copiqpolice/gpx_scolarite_pages/dps_dpg/generalite_pages/libert%C3%A9s_publiques/garanties/controle_constitutionnalite_lois_page.dart';
import 'package:copiqpolice/gpx_scolarite_pages/dps_dpg/generalite_pages/libert%C3%A9s_publiques/garanties/recours_juridictionnels_page.dart';
import 'package:copiqpolice/gpx_scolarite_pages/dps_dpg/generalite_pages/libert%C3%A9s_publiques/garanties/recours_non_juridictionnels_page.dart';
import 'package:copiqpolice/gpx_scolarite_pages/dps_dpg/generalite_pages/libert%C3%A9s_publiques/garanties/recours_organes_internationaux_page.dart';
...
/// =============================================================
class GarantiesProtectionLibertesPage extends StatelessWidget {
  const GarantiesProtectionLibertesPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => Navigator.of(
              context,
            ).pushNamed(QuizGarantiesLibertesPage.routeName),
          ),
          const SizedBox(height: 22),
        ],
      ),
