...
// === PAGES CIBLES ===
import 'package:copiqpolice/gpx_scolarite_pages/dps_dpg/generalite_pages/libert%C3%A9s_publiques/collectives/liberte_presse_page.dart';
import 'package:copiqpolice/gpx_scolarite_pages/dps_dpg/generalite_pages/libert%C3%A9s_publiques/collectives/regime_attroupements_page.dart';
import 'package:copiqpolice/gpx_scolarite_pages/dps_dpg/generalite_pages/libert%C3%A9s_publiques/collectives/regime_manifestations_page.dart';
...
/// =============================================================
class LibertesExpressionCollectivesPage extends StatelessWidget {
  const LibertesExpressionCollectivesPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          _ModuleCard(
            ...
            onTap: () => Navigator.of(
              context,
            ).pushNamed(QuizLibertesPubliquesCollectivesPage.routeName),
          ),
          const SizedBox(height: 22),
        ],
      ),
