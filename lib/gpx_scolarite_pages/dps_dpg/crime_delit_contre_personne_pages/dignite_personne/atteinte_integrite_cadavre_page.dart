...
class AtteinteIntegriteCadavrePage extends StatelessWidget {
  ...
  static const String routeName =
      '/gpx_scolarite_pages/crime_delit_contre_personne_pages/dignite_personne/atteinte_integrite_cadavre';
      ...
      body: ListView(
        ...
        children: [
          ...
          _ConditionCard(
            ...
            titleColor: textMain,
            children: [
              const _SubTitle("A) Le corps d’un défunt"),
              _Paragraph.rich([
                const TextSpan(
                  text:
              ...
              const _SubTitle("B) Une atteinte à l’intégrité du cadavre"),
              const _Paragraph(
              ...
              const SizedBox(height: 10),
              const _SubTitle("Exemples d’atteintes (illustratifs)"),
              const _BulletPoint(
                text:
